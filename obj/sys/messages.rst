...
Hexadecimal [24-Bits]
                                     ...
                                     35 .area _DATA
                                     36 
      001999                         37 _window_data::
      001999 00 00                   38 _window_address: .dw #00
      00199B 00                      39 _window_x: .db #00
      00199C 00                      40 _window_y: .db #00
      00199D 00                      41 _window_w: .db #00
      00199E 00                      42 _window_h: .db #00
      00199F 00 00                   43 _window_message: .dw #0000
      0019A1 01                      44 _window_wait_for_key: .db #01
      0019A2 50 52 45 53 53 20 41    45 _press_any_key_string: .asciz "PRESS ANY KEY"
             4E 59 20 4B 45 59 00
                           ...
                           000008    54 w_wait_for_key = 8
                                     ...
                                     73 ;;
                                     74 
      000662                         75 sys_messages_load_window_data::
      000662 FD 21 99 19      [14]   76     ld iy, #_window_data
      000666 FD 75 06         [19]   77     ld w_message(iy), l
      000669 FD 74 07         [19]   78     ld w_message+1(iy), h
                                     79     ;;ld w_w(iy), c
...
Hexadecimal [24-Bits]
      ...
      00066C FD 70 05         [19]   80     ld w_h(iy), b
                                     81     ;;ld w_x(iy), e             
      00066F FD 72 03         [19]   82     ld w_y(iy), d
      000672 FD 77 08         [19]   83     ld w_wait_for_key(iy), a  
      000675 FD 66 07         [19]   84     ld h, w_message+1(iy)           ;; calculate length of the string
      000678 FD 6E 06         [19]   85     ld l, w_message(iy)             ;;
      00067B CD 6F 14         [17]   86     call sys_text_str_length        ;;
      00067E CB 27            [ 8]   87     sla a                           ;; multiply string length by 2 to obtain bytes
      000680 3C               [ 4]   88     inc a                           ;;
      000681 3C               [ 4]   89     inc a                           ;; add three of bytes as padding
                                     90 
      000682 FE 1E            [ 7]   91     cp #MINIMUM_WINDOW_WIDTH        ;; compare calculated width with minimun width
      000684 F2 89 06         [10]   92     jp p, width_ok                  ;;
      000687 3E 1E            [ 7]   93     ld a, #MINIMUM_WINDOW_WIDTH     ;;
                                     94     
      000689                         95 width_ok:
      000689 FD 77 04         [19]   96     ld w_w(iy), a                   ;; store this information as total width
      00068C FD 34 04         [23]   97     inc w_w(iy)                     ;;
      00068F FD 34 04         [23]   98     inc w_w(iy)                     ;;
      000692 FD 34 04         [23]   99     inc w_w(iy)                     ;; width a little bit wider
                                    100     
      000695 47               [ 4]  101     ld b, a                         ;; move string bytes to b
      000696 3E 50            [ 7]  102     ld a, #80                       ;; move screen width to a
      000698 90               [ 4]  103     sub b                           ;; substract string length
      000699 CB 2F            [ 8]  104     sra a                           ;; divide a to obtain x
      00069B FD 77 02         [19]  105     ld w_x(iy), a
      00069E FD 35 02         [23]  106     dec w_x(iy)                     ;; x adjust
                                    107     
      0006A1 FD 4E 02         [19]  108     ld c, w_x(iy)                   ;; c = x
      0006A4 FD 46 03         [19]  109     ld b, w_y(iy)                   ;; b = y
                                    110     
      ...
      0006A7 3A B2 19         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      0006AA 57               [ 4]    2    ld   d, a
      0006AB 1E 00            [ 7]    3    ld   e, #00
      0006AD CD FF 18         [17]  115     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
                                    116     
      0006B0 FD 75 00         [19]  117     ld w_address(iy), l             ;; keep address in memory
      0006B3 FD 74 01         [19]  118     ld w_address+1(iy), h           ;;
      0006B6 C9               [10]  119     ret
                                    120 
                                    121 ;;-----------------------------------------------------------------
                                    122 ;;
                                    ...
                                    129 ;;
                                    130 
      0006B7                        131 sys_messages_draw_window::
...
Hexadecimal [24-Bits]
      ...
      0006B7 FD 5E 00         [19]  134     ld e, w_address(iy)                 ;; keep background information in message_buffer
      0006BA FD 56 01         [19]  135     ld d, w_address+1(iy)               ;; 
      0006BD FD 4E 04         [19]  136     ld c, w_w(iy)
      0006C0 FD 46 05         [19]  137     ld b, w_h(iy)
                                    138     
      0006C3 3E FF            [ 7]  139     ld a,#0xff                          ;; Patern of solid box
      0006C5 CD 36 18         [17]  140     call cpct_drawSolidBox_asm
                                    141 
      ...
      0006C8 3A B2 19         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      0006CB 57               [ 4]    2    ld   d, a
      0006CC 1E 00            [ 7]    3    ld   e, #00
                                    147     
      0006CE FD 4E 02         [19]  148     ld c, w_x(iy)                   ;;
      0006D1 0C               [ 4]  149     inc c                           ;; C = x coordinate + 1
      0006D2 FD 46 03         [19]  150     ld b, w_y(iy)                   ;;
      0006D5 04               [ 4]  151     inc b                           ;; B = y coordinate + 2
      0006D6 04               [ 4]  152     inc b                           ;;
      0006D7 CD FF 18         [17]  153     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      0006DA EB               [ 4]  154     ex de, hl                       ;; move screen address to de
                                    155     
      0006DB FD 4E 04         [19]  156     ld c, w_w(iy)                   ;;
      0006DE 0D               [ 4]  157     dec c                           ;; C = w - 2
      0006DF 0D               [ 4]  158     dec c                           ;;   
                                    159     
      0006E0 FD 46 05         [19]  160     ld b, w_h(iy)                   ;;
      0006E3 05               [ 4]  161     dec b                           ;; B = h - 4
      0006E4 05               [ 4]  162     dec b                           ;;
      0006E5 05               [ 4]  163     dec b                           ;;
      0006E6 05               [ 4]  164     dec b                           ;;
                                    165     
      0006E7 3E 00            [ 7]  166     ld a, #0x00                     ;; Patern of solid box
      0006E9 CD 36 18         [17]  167     call cpct_drawSolidBox_asm
                                    168 
      0006EC C9               [10]  169     ret
                                    170 
                                    171 
                                    172 
                                    173 ;;-----------------------------------------------------------------
...
Hexadecimal [24-Bits]
                                    ...
                                    184 ;;
      0006ED                        185 sys_messages_restore_message_background::
      0006ED FD 5E 00         [19]  186     ld e, w_address(iy)                 ;; keep background information in message_buffer
      0006F0 FD 56 01         [19]  187     ld d, w_address+1(iy)               ;;
      0006F3 21 E6 07         [10]  188     ld hl, #message_buffer              ;;
      0006F6 FD 4E 04         [19]  189     ld c, w_w(iy)                       ;;
      0006F9 FD 46 05         [19]  190     ld b, w_h(iy)                       ;;
      0006FC CD C3 16         [17]  191     call cpct_drawSprite_asm            ;;
      0006FF C9               [10]  192     ret
                                    193 
                                    194 
                                    195 ;;-----------------------------------------------------------------
                                    196 ;;
                                    ...
                                    206 ;;
                                    207 
      000700                        208 sys_messages_show::
                                    209 
      000700 CD 62 06         [17]  210     call sys_messages_load_window_data
                                    211 
      000703 FD 6E 00         [19]  212     ld l, w_address(iy)                 ;; restore background information from message_buffer
      000706 FD 66 01         [19]  213     ld h, w_address+1(iy)               ;;
      000709 11 E6 07         [10]  214     ld de, #message_buffer              ;;
      00070C FD 4E 04         [19]  215     ld c, w_w(iy)                       ;;
      00070F FD 46 05         [19]  216     ld b, w_h(iy)                       ;;
      000712 CD 78 16         [17]  217     call cpct_getScreenToSprite_asm     ;;
                                    218 
                                    219 
      000715 CD B7 06         [17]  220     call sys_messages_draw_window
                                    221 
                                    222     ;; Draw message
                                    223     
      ...
      000718 3A B2 19         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      00071B 57               [ 4]    2    ld   d, a
      00071C 1E 00            [ 7]    3    ld   e, #00
                                    227     
      00071E FD 4E 02         [19]  228     ld c, w_x(iy)                   ;;
      000721 0C               [ 4]  229     inc c                           ;; 
      000722 0C               [ 4]  230     inc c                           ;; C = x + 1
      000723 0C               [ 4]  231     inc c                           ;; 
                                    232     
      000724 FD 46 03         [19]  233     ld b, w_y(iy)                   ;;
                                    234 
      000727 FD 7E 08         [19]  235     ld a, w_wait_for_key(iy)        ;; check if we have to show the message press any key
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 108.
Hexadecimal [24-Bits]



      00072A FE 01            [ 7]  236     cp #1                           ;;
      00072C 20 04            [12]  237     jr nz, no_wait4key               ;; 
      00072E 3E 0A            [ 7]  238     ld a, #10                       ;; B = y + 10
      000730 18 02            [12]  239     jr y_coord
      000732                        240 no_wait4key:
      000732 3E 0F            [ 7]  241     ld a, #15                       ;; B = y + 15
      000734                        242 y_coord:
      000734 80               [ 4]  243     add b                           ;;
      000735 47               [ 4]  244     ld b, a                         ;;
                                    245     
      000736 CD FF 18         [17]  246     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      000739 EB               [ 4]  247     ex de, hl                       ;; move screen address to de
                                    248 
      00073A 0E 00            [ 7]  249     ld c, #0
      00073C FD 66 07         [19]  250     ld h, w_message+1(iy)
      00073F FD 6E 06         [19]  251     ld l, w_message(iy)
      000742 CD 34 15         [17]  252     call sys_text_draw_string
                                    253 
                                    254     ;; Draw Press Any Key
      000745 FD 7E 08         [19]  255     ld a, w_wait_for_key(iy)        ;; check if we have to wait for a key
      000748 FE 01            [ 7]  256     cp #1                           ;;
      00074A 28 10            [12]  257     jr  z, wait_for_key             ;;
                                    258 
                                    259     ;;call sys_render_switch_buffers
                                    260 
      00074C FD 7E 08         [19]  261     ld a, w_wait_for_key(iy)        ;; check if we have to wait for a key
      00074F FE 02            [ 7]  262     cp #2                           ;;
      000751 20 08            [12]  263     jr  nz, _sms_exit               ;;
                                    264 
      000753                        265 _sms_wait_delay:
      000753 06 32            [ 7]  266     ld b, #50
      000755 CD 49 16         [17]  267     call sys_util_delay
      000758 CD ED 06         [17]  268     call sys_messages_restore_message_background
                                    269 
      00075B                        270 _sms_exit:
      00075B C9               [10]  271     ret
                                    272 
      00075C                        273 wait_for_key:
      ...
      00075C 3A B2 19         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      00075F 57               [ 4]    2    ld   d, a
      000760 1E 00            [ 7]    3    ld   e, #00
                                    278     
                                    279     
      000762 FD 7E 04         [19]  280     ld a, w_w(iy)                   ;;
      000765 0E 1A            [ 7]  281     ld c, #26                       ;;
      000767 91               [ 4]  282     sub c                           ;;
      000768 CB 2F            [ 8]  283     sra a                           ;; c = x + ((w- length(str))/2)
      00076A FD 4E 02         [19]  284     ld c, w_x(iy)                   ;;
      00076D 81               [ 4]  285     add c                           ;;
      00076E 4F               [ 4]  286     ld c, a                         ;;
                                    287 
...
Hexadecimal [24-Bits]
      ...
      00076F FD 46 03         [19]  288     ld b, w_y(iy)                   ;;
      000772 3E 1A            [ 7]  289     ld a, #26                       ;; B = y + 10
      000774 80               [ 4]  290     add b                           ;;
      000775 47               [ 4]  291     ld b, a                         ;;
                                    292     
      000776 CD FF 18         [17]  293     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      000779 EB               [ 4]  294     ex de, hl                       ;; move screen address to de
      00077A 0E 00            [ 7]  295     ld c, #0
      00077C 21 A2 19         [10]  296     ld hl, #_press_any_key_string
      00077F CD 34 15         [17]  297     call sys_text_draw_string
                                    298 
                                    299     ;;call sys_render_switch_buffers
                                    300 
      000782 CD F2 05         [17]  301     call sys_input_wait4anykey
      000785 E5               [11]  302     push hl                         ;; store number of loops waited
                                    303 
      000786 CD ED 06         [17]  304     call sys_messages_restore_message_background
                                    305 
                                    306     ;;call sys_render_switch_buffers
                                    307 
      000789 E1               [10]  308     pop hl                          ;; return number of loops waited
                                    309 
      00078A C9               [10]  310     ret
                                    311 
                                    312 ;;-----------------------------------------------------------------
                                    313 ;;
                                    ...
                                    326 ;;
      00078B                        327 sys_messages_draw_box::
      00078B F5               [11]  328     push af
      00078C 7D               [ 4]  329     ld a, l                             ;;
      00078D B7               [ 4]  330     or a                                ;; Check if box is empty
      00078E 28 09            [12]  331     jr z, smdb_empty                    ;;
                                    332 
                                    333     ;; Draw Back window
      00012E                        334     cpctm_push de, bc
                           000002     1    .narg v
                           000001     2    .if v
      000790 D5               [11]    3    push de
                           000001     4    .if v-1
      000791 C5               [11]    5    push bc
                           000000     6    .if v-2
                                      7    push 
                                      8    .if v-3
...
Hexadecimal [24-Bits]
                           ...
                           000001    23    .else
                                     24    .mexit
      000792 3E 00            [ 7]  335     ld a,#0x00                          ;; Patern of solid box
      000794 CD 36 18         [17]  336     call cpct_drawSolidBox_asm          ;;
      000135                        337     cpctm_pop bc, de
                           000002     1    .narg v
                           000001     2    .if v
      000797 C1               [10]    3    pop bc
                           000001     4    .if v-1
      000798 D1               [10]    5    pop de
                           000000     6    .if v-2
                                      7    pop 
                                      8    .if v-3
                                      9    pop 
                           ...
                           000001    23    .else
                                     24    .mexit
                                    338 
      000799                        339 smdb_empty:
      000799 F1               [10]  340     pop af
      00079A 32 BB 07         [13]  341     ld (#draw_border+1), a
      00079D 32 C4 07         [13]  342     ld (#draw_border2+1), a
      0007A0 32 C8 07         [13]  343     ld (#draw_line+1), a
      0007A3 79               [ 4]  344     ld a, c
      0007A4 32 E4 07         [13]  345     ld (width), a
      0007A7 62               [ 4]  346  	ld h, d
      0007A8 6B               [ 4]  347 	ld l, e	
      0007A9 04               [ 4]  348     inc b                   ;; increment height in one 
      0007AA 18 1B            [12]  349 	jr draw_line
...
Hexadecimal [24-Bits]
                                    ...
                                    350 
      0007AC                        351 next_line:
      0007AC 78               [ 4]  352 	ld a, b
      0007AD 3D               [ 4]  353 	dec a
      0007AE B7               [ 4]  354 	or a
      0007AF C8               [11]  355 	ret z
                                    356 
      0007B0 47               [ 4]  357 	ld b, a
      0007B1 3A E4 07         [13]  358 	ld a, (width)
      0007B4 4F               [ 4]  359 	ld c,a
                                    360 
      0007B5 78               [ 4]  361 	ld a, b
      0007B6 FE 01            [ 7]  362 	cp #1
      0007B8 28 0D            [12]  363 	jr z, draw_line		;; Si estoy en la ultima linea salto a line
      0007BA                        364 draw_border:
      0007BA 36 FF            [10]  365 	ld (hl), #0xff
      0007BC 79               [ 4]  366     ld a, c
      0007BD 3D               [ 4]  367     dec a
      00015C                        368     add_hl_a
      00015C                          1    add_REGPAIR_a  h, l
                                      1    ;; First Perform RH = E + A
      0007BE 85               [ 4]    2    add l    ;; [1] A' = RL + A 
      0007BF 6F               [ 4]    3    ld  l, a ;; [1] RL' = A' = RL + A. It might generate Carry that must be added to RH
                                      4    
                                      5    ;; Then Perform RH = RH + Carry 
      0007C0 8C               [ 4]    6    adc h    ;; [1] A'' = A' + RH + Carry = RL + A + RH + Carry
      0007C1 95               [ 4]    7    sub l    ;; [1] Remove RL'. A''' = A'' - RL' = RL + A + RH + Carry - (RL + A) = RH + Carry
      0007C2 67               [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
      0007C3                        369 draw_border2:
      0007C3 36 FF            [10]  370 	ld (hl), #0xff
      0007C5 18 08            [12]  371 	jr down_line
                                    372 
      0007C7                        373 draw_line:
      0007C7 36 FF            [10]  374 	ld (hl), #0xff
      0007C9 23               [ 6]  375 	inc hl
                                    376 	;;djnz draw_line
      0007CA 0D               [ 4]  377     dec c
      0007CB 79               [ 4]  378     ld a, c
      0007CC B7               [ 4]  379     or a
      0007CD 20 F8            [12]  380     jr nz, draw_line
                                    381 
      0007CF                        382 down_line:
      0007CF 3E 08            [ 7]  383 	ld a, #8          	    ;; [2] / HL = DE = DE + 0x800
      0007D1 82               [ 4]  384 	add d
      0007D2 67               [ 4]  385     ld h, a           	    ;; [1] | Adding 0x800 makes HL point to the start of
      0007D3 57               [ 4]  386 	ld d, a
      0007D4 6B               [ 4]  387 	ld l, e
                                    388 	
      0007D5 E6 38            [ 7]  389 	and   #0x38        	    ;; [2] leave out only bits 13,12 and 11 from new memory address (00xxx000 00000000)
      0007D7 C2 AC 07         [10]  390     jp    nz, next_line    	;; [3] If any bit from {13,12,11} is not 0, we are still inside 
...
Hexadecimal [24-Bits]
      ...
      0007DA 21 50 C0         [10]  396     ld    hl, #0xC050       ;; [3] We advance destination pointer to next line
      0007DD 19               [11]  397     add   hl, de            ;; [3] HL = DE + 0xC050
      0007DE 54               [ 4]  398     ld     d, h             ;; [1] / DE = HL
      0007DF 5D               [ 4]  399     ld     e, l             ;; [1] \
      0007E0 C3 AC 07         [10]  400     jp   next_line         	;; [3] Continue copying
                                    401 
      0007E3 C9               [10]  402     ret
      0007E4 00                     403 width: .db #0
      0007E5 00                     404 height: .db #0
      0007E6                        405 message_buffer: .ds 3000
