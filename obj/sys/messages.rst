...
Hexadecimal [16-Bits]
                             ...
                             35 .area _DATA
                             36 
   1B69                      37 _window_data::
   1B69 00 00                38 _window_address: .dw #00
   1B6B 00                   39 _window_x: .db #00
   1B6C 00                   40 _window_y: .db #00
   1B6D 00                   41 _window_w: .db #00
   1B6E 00                   42 _window_h: .db #00
   1B6F 00 00                43 _window_message: .dw #0000
   1B71 01                   44 _window_wait_for_key: .db #01
   1B72 50 52 45 53 53 20    45 _press_any_key_string: .asciz "PRESS ANY KEY"
        41 4E 59 20 4B 45
        59 00
                             46 
                     ...
                     0008    54 w_wait_for_key = 8
                             ...
                             73 ;;
                             74 
   09CD                      75 sys_messages_load_window_data::
   09CD FD 21 69 1B   [14]   76     ld iy, #_window_data
   09D1 FD 75 06      [19]   77     ld w_message(iy), l
   09D4 FD 74 07      [19]   78     ld w_message+1(iy), h
...
Hexadecimal [16-Bits]
                             ...
                             79     ;;ld w_w(iy), c
   09D7 FD 70 05      [19]   80     ld w_h(iy), b
                             81     ;;ld w_x(iy), e             
   09DA FD 72 03      [19]   82     ld w_y(iy), d
   09DD FD 77 08      [19]   83     ld w_wait_for_key(iy), a  
   09E0 FD 66 07      [19]   84     ld h, w_message+1(iy)           ;; calculate length of the string
   09E3 FD 6E 06      [19]   85     ld l, w_message(iy)             ;;
   09E6 CD 5E 08      [17]   86     call sys_text_str_length        ;;
   09E9 CB 27         [ 8]   87     sla a                           ;; multiply string length by 2 to obtain bytes
   09EB 3C            [ 4]   88     inc a                           ;;
   09EC 3C            [ 4]   89     inc a                           ;; add three of bytes as padding
                             90 
   09ED FE 1E         [ 7]   91     cp #MINIMUM_WINDOW_WIDTH        ;; compare calculated width with minimun width
   09EF F2 F4 09      [10]   92     jp p, width_ok                  ;;
   09F2 3E 1E         [ 7]   93     ld a, #MINIMUM_WINDOW_WIDTH     ;;
                             94     
   09F4                      95 width_ok:
   09F4 FD 77 04      [19]   96     ld w_w(iy), a                   ;; store this information as total width
   09F7 FD 34 04      [23]   97     inc w_w(iy)                     ;;
   09FA FD 34 04      [23]   98     inc w_w(iy)                     ;;
   09FD FD 34 04      [23]   99     inc w_w(iy)                     ;; width a little bit wider
                            100     
   0A00 47            [ 4]  101     ld b, a                         ;; move string bytes to b
   0A01 3E 50         [ 7]  102     ld a, #80                       ;; move screen width to a
   0A03 90            [ 4]  103     sub b                           ;; substract string length
   0A04 CB 2F         [ 8]  104     sra a                           ;; divide a to obtain x
   0A06 FD 77 02      [19]  105     ld w_x(iy), a
   0A09 FD 35 02      [23]  106     dec w_x(iy)                     ;; x adjust
                            107     
   0A0C FD 4E 02      [19]  108     ld c, w_x(iy)                   ;; c = x
   0A0F FD 46 03      [19]  109     ld b, w_y(iy)                   ;; b = y
                            110     
   ...
   0A12 3A 47 1B      [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
   0A15 57            [ 4]    2    ld   d, a
   0A16 1E 00         [ 7]    3    ld   e, #00
   0A18 CD B8 1A      [17]  115     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
                            116     
   0A1B FD 75 00      [19]  117     ld w_address(iy), l             ;; keep address in memory
   0A1E FD 74 01      [19]  118     ld w_address+1(iy), h           ;;
   0A21 C9            [10]  119     ret
                            120 
                            121 ;;-----------------------------------------------------------------
                            122 ;;
...
Hexadecimal [16-Bits]
   ...
   0A22                     131 sys_messages_draw_window::
                            132 
                            133     ;; Draw Back window
   0A22 FD 5E 00      [19]  134     ld e, w_address(iy)                 ;; keep background information in message_buffer
   0A25 FD 56 01      [19]  135     ld d, w_address+1(iy)               ;; 
   0A28 FD 4E 04      [19]  136     ld c, w_w(iy)
   0A2B FD 46 05      [19]  137     ld b, w_h(iy)
                            138     
   0A2E 3E FF         [ 7]  139     ld a,#0xff                          ;; Patern of solid box
   0A30 CD C8 19      [17]  140     call cpct_drawSolidBox_asm
                            141 
   ...
   0A33 3A 47 1B      [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
   0A36 57            [ 4]    2    ld   d, a
   0A37 1E 00         [ 7]    3    ld   e, #00
                            147     
   0A39 FD 4E 02      [19]  148     ld c, w_x(iy)                   ;;
   0A3C 0C            [ 4]  149     inc c                           ;; C = x coordinate + 1
   0A3D FD 46 03      [19]  150     ld b, w_y(iy)                   ;;
   0A40 04            [ 4]  151     inc b                           ;; B = y coordinate + 2
   0A41 04            [ 4]  152     inc b                           ;;
   0A42 CD B8 1A      [17]  153     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
   0A45 EB            [ 4]  154     ex de, hl                       ;; move screen address to de
                            155     
   0A46 FD 4E 04      [19]  156     ld c, w_w(iy)                   ;;
   0A49 0D            [ 4]  157     dec c                           ;; C = w - 2
   0A4A 0D            [ 4]  158     dec c                           ;;   
                            159     
   0A4B FD 46 05      [19]  160     ld b, w_h(iy)                   ;;
   0A4E 05            [ 4]  161     dec b                           ;; B = h - 4
   0A4F 05            [ 4]  162     dec b                           ;;
   0A50 05            [ 4]  163     dec b                           ;;
   0A51 05            [ 4]  164     dec b                           ;;
                            165     
   0A52 3E 00         [ 7]  166     ld a, #0x00                     ;; Patern of solid box
   0A54 CD C8 19      [17]  167     call cpct_drawSolidBox_asm
                            168 
   0A57 C9            [10]  169     ret
                            170 
                            171 
...
Hexadecimal [16-Bits]
                            ...
                            184 ;;
   0A58                     185 sys_messages_restore_message_background::
   0A58 FD 5E 00      [19]  186     ld e, w_address(iy)                 ;; keep background information in message_buffer
   0A5B FD 56 01      [19]  187     ld d, w_address+1(iy)               ;;
   0A5E 21 51 0B      [10]  188     ld hl, #message_buffer              ;;
   0A61 FD 4E 04      [19]  189     ld c, w_w(iy)                       ;;
   0A64 FD 46 05      [19]  190     ld b, w_h(iy)                       ;;
   0A67 CD F1 17      [17]  191     call cpct_drawSprite_asm            ;;
   0A6A C9            [10]  192     ret
                            193 
                            194 
                            195 ;;-----------------------------------------------------------------
                            ...
                            206 ;;
                            207 
   0A6B                     208 sys_messages_show::
                            209 
   0A6B CD CD 09      [17]  210     call sys_messages_load_window_data
                            211 
   0A6E FD 6E 00      [19]  212     ld l, w_address(iy)                 ;; restore background information from message_buffer
   0A71 FD 66 01      [19]  213     ld h, w_address+1(iy)               ;;
   0A74 11 51 0B      [10]  214     ld de, #message_buffer              ;;
   0A77 FD 4E 04      [19]  215     ld c, w_w(iy)                       ;;
   0A7A FD 46 05      [19]  216     ld b, w_h(iy)                       ;;
   0A7D CD A6 17      [17]  217     call cpct_getScreenToSprite_asm     ;;
                            218 
                            219 
   0A80 CD 22 0A      [17]  220     call sys_messages_draw_window
                            221 
                            222     ;; Draw message
                            223     
   ...
   0A83 3A 47 1B      [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
   0A86 57            [ 4]    2    ld   d, a
   0A87 1E 00         [ 7]    3    ld   e, #00
                            227     
   0A89 FD 4E 02      [19]  228     ld c, w_x(iy)                   ;;
   0A8C 0C            [ 4]  229     inc c                           ;; 
   0A8D 0C            [ 4]  230     inc c                           ;; C = x + 1
   0A8E 0C            [ 4]  231     inc c                           ;; 
                            232     
   0A8F FD 46 03      [19]  233     ld b, w_y(iy)                   ;;
                            234 
...
Hexadecimal [16-Bits]
   ...
   0A92 FD 7E 08      [19]  235     ld a, w_wait_for_key(iy)        ;; check if we have to show the message press any key
   0A95 FE 01         [ 7]  236     cp #1                           ;;
   0A97 20 04         [12]  237     jr nz, no_wait4key               ;; 
   0A99 3E 0A         [ 7]  238     ld a, #10                       ;; B = y + 10
   0A9B 18 02         [12]  239     jr y_coord
   0A9D                     240 no_wait4key:
   0A9D 3E 0F         [ 7]  241     ld a, #15                       ;; B = y + 15
   0A9F                     242 y_coord:
   0A9F 80            [ 4]  243     add b                           ;;
   0AA0 47            [ 4]  244     ld b, a                         ;;
                            245     
   0AA1 CD B8 1A      [17]  246     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
   0AA4 EB            [ 4]  247     ex de, hl                       ;; move screen address to de
                            248 
   0AA5 0E 00         [ 7]  249     ld c, #0
   0AA7 FD 66 07      [19]  250     ld h, w_message+1(iy)
   0AAA FD 6E 06      [19]  251     ld l, w_message(iy)
   0AAD CD 23 09      [17]  252     call sys_text_draw_string
                            253 
                            254     ;; Draw Press Any Key
   0AB0 FD 7E 08      [19]  255     ld a, w_wait_for_key(iy)        ;; check if we have to wait for a key
   0AB3 FE 01         [ 7]  256     cp #1                           ;;
   0AB5 28 10         [12]  257     jr  z, wait_for_key             ;;
                            258 
                            259     ;;call sys_render_switch_buffers
                            260 
   0AB7 FD 7E 08      [19]  261     ld a, w_wait_for_key(iy)        ;; check if we have to wait for a key
   0ABA FE 02         [ 7]  262     cp #2                           ;;
   0ABC 20 08         [12]  263     jr  nz, _sms_exit               ;;
                            264 
   0ABE                     265 _sms_wait_delay:
   0ABE 06 32         [ 7]  266     ld b, #50
   0AC0 CD 4B 08      [17]  267     call sys_util_delay
   0AC3 CD 58 0A      [17]  268     call sys_messages_restore_message_background
                            269 
   0AC6                     270 _sms_exit:
   0AC6 C9            [10]  271     ret
                            272 
   0AC7                     273 wait_for_key:
   ...
   0AC7 3A 47 1B      [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
   0ACA 57            [ 4]    2    ld   d, a
   0ACB 1E 00         [ 7]    3    ld   e, #00
                            278     
                            279     
   0ACD FD 7E 04      [19]  280     ld a, w_w(iy)                   ;;
   0AD0 0E 1A         [ 7]  281     ld c, #26                       ;;
   0AD2 91            [ 4]  282     sub c                           ;;
   0AD3 CB 2F         [ 8]  283     sra a                           ;; c = x + ((w- length(str))/2)
   0AD5 FD 4E 02      [19]  284     ld c, w_x(iy)                   ;;
   0AD8 81            [ 4]  285     add c                           ;;
   0AD9 4F            [ 4]  286     ld c, a                         ;;
...
Hexadecimal [16-Bits]
                            ...
                            287 
   0ADA FD 46 03      [19]  288     ld b, w_y(iy)                   ;;
   0ADD 3E 1A         [ 7]  289     ld a, #26                       ;; B = y + 10
   0ADF 80            [ 4]  290     add b                           ;;
   0AE0 47            [ 4]  291     ld b, a                         ;;
                            292     
   0AE1 CD B8 1A      [17]  293     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
   0AE4 EB            [ 4]  294     ex de, hl                       ;; move screen address to de
   0AE5 0E 00         [ 7]  295     ld c, #0
   0AE7 21 72 1B      [10]  296     ld hl, #_press_any_key_string
   0AEA CD 23 09      [17]  297     call sys_text_draw_string
                            298 
                            299     ;;call sys_render_switch_buffers
                            300 
   0AED CD 0F 17      [17]  301     call sys_input_wait4anykey
   0AF0 E5            [11]  302     push hl                         ;; store number of loops waited
                            303 
   0AF1 CD 58 0A      [17]  304     call sys_messages_restore_message_background
                            305 
                            306     ;;call sys_render_switch_buffers
                            307 
   0AF4 E1            [10]  308     pop hl                          ;; return number of loops waited
                            309 
   0AF5 C9            [10]  310     ret
                            311 
                            312 ;;-----------------------------------------------------------------
                            ...
                            326 ;;
   0AF6                     327 sys_messages_draw_box::
   0AF6 F5            [11]  328     push af
   0AF7 7D            [ 4]  329     ld a, l                             ;;
   0AF8 B7            [ 4]  330     or a                                ;; Check if box is empty
   0AF9 28 09         [12]  331     jr z, smdb_empty                    ;;
                            332 
                            333     ;; Draw Back window
   012E                     334     cpctm_push de, bc
                     0002     1    .narg v
                     0001     2    .if v
   0AFB D5            [11]    3    push de
                     0001     4    .if v-1
   0AFC C5            [11]    5    push bc
                     0000     6    .if v-2
                              7    push 
...
Hexadecimal [16-Bits]
                     ...
                     0001    23    .else
                             24    .mexit
   0AFD 3E 00         [ 7]  335     ld a,#0x00                          ;; Patern of solid box
   0AFF CD C8 19      [17]  336     call cpct_drawSolidBox_asm          ;;
   ...
   0B03 D1            [10]    5    pop de
                     ...
                     0001    23    .else
                            ...
                            338 
   0B04                     339 smdb_empty:
   0B04 F1            [10]  340     pop af
   0B05 32 26 0B      [13]  341     ld (#draw_border+1), a
   0B08 32 2F 0B      [13]  342     ld (#draw_border2+1), a
   0B0B 32 33 0B      [13]  343     ld (#draw_line+1), a
   0B0E 79            [ 4]  344     ld a, c
   0B0F 32 4F 0B      [13]  345     ld (width), a
   0B12 62            [ 4]  346  	ld h, d
   0B13 6B            [ 4]  347 	ld l, e	
   0B14 04            [ 4]  348     inc b                   ;; increment height in one 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 111.
Hexadecimal [16-Bits]



   0B15 18 1B         [12]  349 	jr draw_line
                            350 
   0B17                     351 next_line:
   0B17 78            [ 4]  352 	ld a, b
   0B18 3D            [ 4]  353 	dec a
   0B19 B7            [ 4]  354 	or a
   0B1A C8            [11]  355 	ret z
                            356 
   0B1B 47            [ 4]  357 	ld b, a
   0B1C 3A 4F 0B      [13]  358 	ld a, (width)
   0B1F 4F            [ 4]  359 	ld c,a
                            360 
   0B20 78            [ 4]  361 	ld a, b
   0B21 FE 01         [ 7]  362 	cp #1
   0B23 28 0D         [12]  363 	jr z, draw_line		;; Si estoy en la ultima linea salto a line
   0B25                     364 draw_border:
   0B25 36 FF         [10]  365 	ld (hl), #0xff
   0B27 79            [ 4]  366     ld a, c
   0B28 3D            [ 4]  367     dec a
   015C                     368     add_hl_a
   015C                       1    add_REGPAIR_a  h, l
                              1    ;; First Perform RH = E + A
   0B29 85            [ 4]    2    add l    ;; [1] A' = RL + A 
   0B2A 6F            [ 4]    3    ld  l, a ;; [1] RL' = A' = RL + A. It might generate Carry that must be added to RH
                              4    
                              5    ;; Then Perform RH = RH + Carry 
   0B2B 8C            [ 4]    6    adc h    ;; [1] A'' = A' + RH + Carry = RL + A + RH + Carry
   0B2C 95            [ 4]    7    sub l    ;; [1] Remove RL'. A''' = A'' - RL' = RL + A + RH + Carry - (RL + A) = RH + Carry
   0B2D 67            [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
   0B2E                     369 draw_border2:
   0B2E 36 FF         [10]  370 	ld (hl), #0xff
   0B30 18 08         [12]  371 	jr down_line
                            372 
   0B32                     373 draw_line:
   0B32 36 FF         [10]  374 	ld (hl), #0xff
   0B34 23            [ 6]  375 	inc hl
                            376 	;;djnz draw_line
   0B35 0D            [ 4]  377     dec c
   0B36 79            [ 4]  378     ld a, c
   0B37 B7            [ 4]  379     or a
   0B38 20 F8         [12]  380     jr nz, draw_line
                            381 
   0B3A                     382 down_line:
   0B3A 3E 08         [ 7]  383 	ld a, #8          	    ;; [2] / HL = DE = DE + 0x800
   0B3C 82            [ 4]  384 	add d
   0B3D 67            [ 4]  385     ld h, a           	    ;; [1] | Adding 0x800 makes HL point to the start of
   0B3E 57            [ 4]  386 	ld d, a
   0B3F 6B            [ 4]  387 	ld l, e
                            388 	
   0B40 E6 38         [ 7]  389 	and   #0x38        	    ;; [2] leave out only bits 13,12 and 11 from new memory address (00xxx000 00000000)
   0B42 C2 17 0B      [10]  390     jp    nz, next_line    	;; [3] If any bit from {13,12,11} is not 0, we are still inside 
...
Hexadecimal [16-Bits]
   ...
   0B45 21 50 C0      [10]  396     ld    hl, #0xC050       ;; [3] We advance destination pointer to next line
   0B48 19            [11]  397     add   hl, de            ;; [3] HL = DE + 0xC050
   0B49 54            [ 4]  398     ld     d, h             ;; [1] / DE = HL
   0B4A 5D            [ 4]  399     ld     e, l             ;; [1] \
   0B4B C3 17 0B      [10]  400     jp   next_line         	;; [3] Continue copying
                            401 
   0B4E C9            [10]  402     ret
   0B4F 00                  403 width: .db #0
   0B50 00                  404 height: .db #0
   0B51                     405 message_buffer: .ds 3000
