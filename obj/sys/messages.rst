...
Hexadecimal [24-Bits]
                                     ...
                                     25 ;; Global routines
                                     26 ;;------------------------------------------------------------------------------
                                     27 .globl sys_input_init
                                     28 .globl sys_input_clean_buffer
                                     29 .globl sys_input_wait4anykey
                                     30 .globl sys_input_waitKeyPressed
                                     31 .globl sys_input_getKeyPressed
                                     32 
                                     33 .globl sys_input_main_menu_update
                                     34 
...
Hexadecimal [24-Bits]
                                     ...
                                     35 .area _DATA
                                     36 
      001BBC                         37 _window_data::
      001BBC 00 00                   38 _window_address: .dw #00
      001BBE 00                      39 _window_x: .db #00
      001BBF 00                      40 _window_y: .db #00
      001BC0 00                      41 _window_w: .db #00
      001BC1 00                      42 _window_h: .db #00
      001BC2 00 00                   43 _window_message: .dw #0000
      001BC4 01                      44 _window_wait_for_key: .db #01
      001BC5 50 52 45 53 53 20 41    45 _press_any_key_string: .asciz "PRESS ANY KEY"
             4E 59 20 4B 45 59 00
                           ...
                           000008    54 w_wait_for_key = 8
                                     ...
                                     73 ;;
                                     74 
      000792                         75 sys_messages_load_window_data::
      000792 FD 21 BC 1B      [14]   76     ld iy, #_window_data
      000796 FD 75 06         [19]   77     ld w_message(iy), l
      000799 FD 74 07         [19]   78     ld w_message+1(iy), h
                                     79     ;;ld w_w(iy), c
...
Hexadecimal [24-Bits]
      ...
      00079C FD 70 05         [19]   80     ld w_h(iy), b
                                     81     ;;ld w_x(iy), e             
      00079F FD 72 03         [19]   82     ld w_y(iy), d
      0007A2 FD 77 08         [19]   83     ld w_wait_for_key(iy), a  
      0007A5 FD 66 07         [19]   84     ld h, w_message+1(iy)           ;; calculate length of the string
      0007A8 FD 6E 06         [19]   85     ld l, w_message(iy)             ;;
      0007AB CD 9F 15         [17]   86     call sys_text_str_length        ;;
      0007AE CB 27            [ 8]   87     sla a                           ;; multiply string length by 2 to obtain bytes
      0007B0 3C               [ 4]   88     inc a                           ;;
      0007B1 3C               [ 4]   89     inc a                           ;; add three of bytes as padding
                                     90 
      0007B2 FE 1E            [ 7]   91     cp #MINIMUM_WINDOW_WIDTH        ;; compare calculated width with minimun width
      0007B4 F2 B9 07         [10]   92     jp p, width_ok                  ;;
      0007B7 3E 1E            [ 7]   93     ld a, #MINIMUM_WINDOW_WIDTH     ;;
                                     94     
      0007B9                         95 width_ok:
      0007B9 FD 77 04         [19]   96     ld w_w(iy), a                   ;; store this information as total width
      0007BC FD 34 04         [23]   97     inc w_w(iy)                     ;;
      0007BF FD 34 04         [23]   98     inc w_w(iy)                     ;;
      0007C2 FD 34 04         [23]   99     inc w_w(iy)                     ;; width a little bit wider
                                    100     
      0007C5 47               [ 4]  101     ld b, a                         ;; move string bytes to b
      0007C6 3E 50            [ 7]  102     ld a, #80                       ;; move screen width to a
      0007C8 90               [ 4]  103     sub b                           ;; substract string length
      0007C9 CB 2F            [ 8]  104     sra a                           ;; divide a to obtain x
      0007CB FD 77 02         [19]  105     ld w_x(iy), a
      0007CE FD 35 02         [23]  106     dec w_x(iy)                     ;; x adjust
                                    107     
      0007D1 FD 4E 02         [19]  108     ld c, w_x(iy)                   ;; c = x
      0007D4 FD 46 03         [19]  109     ld b, w_y(iy)                   ;; b = y
                                    110     
      ...
      0007D7 3A D5 1B         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      0007DA 57               [ 4]    2    ld   d, a
      0007DB 1E 00            [ 7]    3    ld   e, #00
      0007DD CD BA 1A         [17]  115     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
                                    116     
      0007E0 FD 75 00         [19]  117     ld w_address(iy), l             ;; keep address in memory
      0007E3 FD 74 01         [19]  118     ld w_address+1(iy), h           ;;
      0007E6 C9               [10]  119     ret
                                    120 
                                    121 ;;-----------------------------------------------------------------
                                    122 ;;
                                    ...
                                    129 ;;
                                    130 
      0007E7                        131 sys_messages_draw_window::
...
Hexadecimal [24-Bits]
      ...
      0007E7 FD 5E 00         [19]  134     ld e, w_address(iy)                 ;; keep background information in message_buffer
      0007EA FD 56 01         [19]  135     ld d, w_address+1(iy)               ;; 
      0007ED FD 4E 04         [19]  136     ld c, w_w(iy)
      0007F0 FD 46 05         [19]  137     ld b, w_h(iy)
                                    138     
      0007F3 3E FF            [ 7]  139     ld a,#0xff                          ;; Patern of solid box
      0007F5 CD CA 19         [17]  140     call cpct_drawSolidBox_asm
                                    141 
      ...
      0007F8 3A D5 1B         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      0007FB 57               [ 4]    2    ld   d, a
      0007FC 1E 00            [ 7]    3    ld   e, #00
                                    147     
      0007FE FD 4E 02         [19]  148     ld c, w_x(iy)                   ;;
      000801 0C               [ 4]  149     inc c                           ;; C = x coordinate + 1
      000802 FD 46 03         [19]  150     ld b, w_y(iy)                   ;;
      000805 04               [ 4]  151     inc b                           ;; B = y coordinate + 2
      000806 04               [ 4]  152     inc b                           ;;
      000807 CD BA 1A         [17]  153     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      00080A EB               [ 4]  154     ex de, hl                       ;; move screen address to de
                                    155     
      00080B FD 4E 04         [19]  156     ld c, w_w(iy)                   ;;
      00080E 0D               [ 4]  157     dec c                           ;; C = w - 2
      00080F 0D               [ 4]  158     dec c                           ;;   
                                    159     
      000810 FD 46 05         [19]  160     ld b, w_h(iy)                   ;;
      000813 05               [ 4]  161     dec b                           ;; B = h - 4
      000814 05               [ 4]  162     dec b                           ;;
      000815 05               [ 4]  163     dec b                           ;;
      000816 05               [ 4]  164     dec b                           ;;
                                    165     
      000817 3E 00            [ 7]  166     ld a, #0x00                     ;; Patern of solid box
      000819 CD CA 19         [17]  167     call cpct_drawSolidBox_asm
                                    168 
      00081C C9               [10]  169     ret
                                    170 
                                    171 
                                    172 
                                    173 ;;-----------------------------------------------------------------
...
Hexadecimal [24-Bits]
                                    ...
                                    184 ;;
      00081D                        185 sys_messages_restore_message_background::
      00081D FD 5E 00         [19]  186     ld e, w_address(iy)                 ;; keep background information in message_buffer
      000820 FD 56 01         [19]  187     ld d, w_address+1(iy)               ;;
      000823 21 16 09         [10]  188     ld hl, #message_buffer              ;;
      000826 FD 4E 04         [19]  189     ld c, w_w(iy)                       ;;
      000829 FD 46 05         [19]  190     ld b, w_h(iy)                       ;;
      00082C CD F3 17         [17]  191     call cpct_drawSprite_asm            ;;
      00082F C9               [10]  192     ret
                                    193 
                                    194 
                                    195 ;;-----------------------------------------------------------------
                                    196 ;;
                                    ...
                                    206 ;;
                                    207 
      000830                        208 sys_messages_show::
                                    209 
      000830 CD 92 07         [17]  210     call sys_messages_load_window_data
                                    211 
      000833 FD 6E 00         [19]  212     ld l, w_address(iy)                 ;; restore background information from message_buffer
      000836 FD 66 01         [19]  213     ld h, w_address+1(iy)               ;;
      000839 11 16 09         [10]  214     ld de, #message_buffer              ;;
      00083C FD 4E 04         [19]  215     ld c, w_w(iy)                       ;;
      00083F FD 46 05         [19]  216     ld b, w_h(iy)                       ;;
      000842 CD A8 17         [17]  217     call cpct_getScreenToSprite_asm     ;;
                                    218 
                                    219 
      000845 CD E7 07         [17]  220     call sys_messages_draw_window
                                    221 
                                    222     ;; Draw message
                                    223     
      ...
      000848 3A D5 1B         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      00084B 57               [ 4]    2    ld   d, a
      00084C 1E 00            [ 7]    3    ld   e, #00
                                    227     
      00084E FD 4E 02         [19]  228     ld c, w_x(iy)                   ;;
      000851 0C               [ 4]  229     inc c                           ;; 
      000852 0C               [ 4]  230     inc c                           ;; C = x + 1
      000853 0C               [ 4]  231     inc c                           ;; 
                                    232     
      000854 FD 46 03         [19]  233     ld b, w_y(iy)                   ;;
                                    234 
      000857 FD 7E 08         [19]  235     ld a, w_wait_for_key(iy)        ;; check if we have to show the message press any key
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 108.
Hexadecimal [24-Bits]



      00085A FE 01            [ 7]  236     cp #1                           ;;
      00085C 20 04            [12]  237     jr nz, no_wait4key               ;; 
      00085E 3E 0A            [ 7]  238     ld a, #10                       ;; B = y + 10
      000860 18 02            [12]  239     jr y_coord
      000862                        240 no_wait4key:
      000862 3E 0F            [ 7]  241     ld a, #15                       ;; B = y + 15
      000864                        242 y_coord:
      000864 80               [ 4]  243     add b                           ;;
      000865 47               [ 4]  244     ld b, a                         ;;
                                    245     
      000866 CD BA 1A         [17]  246     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      000869 EB               [ 4]  247     ex de, hl                       ;; move screen address to de
                                    248 
      00086A 0E 00            [ 7]  249     ld c, #0
      00086C FD 66 07         [19]  250     ld h, w_message+1(iy)
      00086F FD 6E 06         [19]  251     ld l, w_message(iy)
      000872 CD 64 16         [17]  252     call sys_text_draw_string
                                    253 
                                    254     ;; Draw Press Any Key
      000875 FD 7E 08         [19]  255     ld a, w_wait_for_key(iy)        ;; check if we have to wait for a key
      000878 FE 01            [ 7]  256     cp #1                           ;;
      00087A 28 10            [12]  257     jr  z, wait_for_key             ;;
                                    258 
                                    259     ;;call sys_render_switch_buffers
                                    260 
      00087C FD 7E 08         [19]  261     ld a, w_wait_for_key(iy)        ;; check if we have to wait for a key
      00087F FE 02            [ 7]  262     cp #2                           ;;
      000881 20 08            [12]  263     jr  nz, _sms_exit               ;;
                                    264 
      000883                        265 _sms_wait_delay:
      000883 06 32            [ 7]  266     ld b, #50
      000885 CD 79 17         [17]  267     call sys_util_delay
      000888 CD 1D 08         [17]  268     call sys_messages_restore_message_background
                                    269 
      00088B                        270 _sms_exit:
      00088B C9               [10]  271     ret
                                    272 
      00088C                        273 wait_for_key:
      ...
      00088C 3A D5 1B         [13]    1    ld   a, (sys_render_front_buffer)         ;; DE = Pointer to start of the screen
      00088F 57               [ 4]    2    ld   d, a
      000890 1E 00            [ 7]    3    ld   e, #00
                                    278     
                                    279     
      000892 FD 7E 04         [19]  280     ld a, w_w(iy)                   ;;
      000895 0E 1A            [ 7]  281     ld c, #26                       ;;
      000897 91               [ 4]  282     sub c                           ;;
      000898 CB 2F            [ 8]  283     sra a                           ;; c = x + ((w- length(str))/2)
      00089A FD 4E 02         [19]  284     ld c, w_x(iy)                   ;;
      00089D 81               [ 4]  285     add c                           ;;
      00089E 4F               [ 4]  286     ld c, a                         ;;
                                    287 
...
Hexadecimal [24-Bits]
      ...
      00089F FD 46 03         [19]  288     ld b, w_y(iy)                   ;;
      0008A2 3E 1A            [ 7]  289     ld a, #26                       ;; B = y + 10
      0008A4 80               [ 4]  290     add b                           ;;
      0008A5 47               [ 4]  291     ld b, a                         ;;
                                    292     
      0008A6 CD BA 1A         [17]  293     call cpct_getScreenPtr_asm      ;; Calculate video memory location and return it in HL
      0008A9 EB               [ 4]  294     ex de, hl                       ;; move screen address to de
      0008AA 0E 00            [ 7]  295     ld c, #0
      0008AC 21 C5 1B         [10]  296     ld hl, #_press_any_key_string
      0008AF CD 64 16         [17]  297     call sys_text_draw_string
                                    298 
                                    299     ;;call sys_render_switch_buffers
                                    300 
      0008B2 CD 22 07         [17]  301     call sys_input_wait4anykey
      0008B5 E5               [11]  302     push hl                         ;; store number of loops waited
                                    303 
      0008B6 CD 1D 08         [17]  304     call sys_messages_restore_message_background
                                    305 
                                    306     ;;call sys_render_switch_buffers
                                    307 
      0008B9 E1               [10]  308     pop hl                          ;; return number of loops waited
                                    309 
      0008BA C9               [10]  310     ret
                                    311 
                                    312 ;;-----------------------------------------------------------------
                                    313 ;;
                                    ...
                                    326 ;;
      0008BB                        327 sys_messages_draw_box::
      0008BB F5               [11]  328     push af
      0008BC 7D               [ 4]  329     ld a, l                             ;;
      0008BD B7               [ 4]  330     or a                                ;; Check if box is empty
      0008BE 28 09            [12]  331     jr z, smdb_empty                    ;;
                                    332 
                                    333     ;; Draw Back window
      00012E                        334     cpctm_push de, bc
                           000002     1    .narg v
                           000001     2    .if v
      0008C0 D5               [11]    3    push de
                           000001     4    .if v-1
      0008C1 C5               [11]    5    push bc
                           000000     6    .if v-2
                                      7    push 
                                      8    .if v-3
...
Hexadecimal [24-Bits]
                           ...
                           000001    23    .else
                                     24    .mexit
      0008C2 3E 00            [ 7]  335     ld a,#0x00                          ;; Patern of solid box
      0008C4 CD CA 19         [17]  336     call cpct_drawSolidBox_asm          ;;
      000135                        337     cpctm_pop bc, de
                           000002     1    .narg v
                           000001     2    .if v
      0008C7 C1               [10]    3    pop bc
                           000001     4    .if v-1
      0008C8 D1               [10]    5    pop de
                           000000     6    .if v-2
                                      7    pop 
                                      8    .if v-3
                                      9    pop 
                           ...
                           000001    23    .else
                                     24    .mexit
                                    338 
      0008C9                        339 smdb_empty:
      0008C9 F1               [10]  340     pop af
      0008CA 32 EB 08         [13]  341     ld (#draw_border+1), a
      0008CD 32 F4 08         [13]  342     ld (#draw_border2+1), a
      0008D0 32 F8 08         [13]  343     ld (#draw_line+1), a
      0008D3 79               [ 4]  344     ld a, c
      0008D4 32 14 09         [13]  345     ld (width), a
      0008D7 62               [ 4]  346  	ld h, d
      0008D8 6B               [ 4]  347 	ld l, e	
      0008D9 04               [ 4]  348     inc b                   ;; increment height in one 
      0008DA 18 1B            [12]  349 	jr draw_line
...
Hexadecimal [24-Bits]
                                    ...
                                    350 
      0008DC                        351 next_line:
      0008DC 78               [ 4]  352 	ld a, b
      0008DD 3D               [ 4]  353 	dec a
      0008DE B7               [ 4]  354 	or a
      0008DF C8               [11]  355 	ret z
                                    356 
      0008E0 47               [ 4]  357 	ld b, a
      0008E1 3A 14 09         [13]  358 	ld a, (width)
      0008E4 4F               [ 4]  359 	ld c,a
                                    360 
      0008E5 78               [ 4]  361 	ld a, b
      0008E6 FE 01            [ 7]  362 	cp #1
      0008E8 28 0D            [12]  363 	jr z, draw_line		;; Si estoy en la ultima linea salto a line
      0008EA                        364 draw_border:
      0008EA 36 FF            [10]  365 	ld (hl), #0xff
      0008EC 79               [ 4]  366     ld a, c
      0008ED 3D               [ 4]  367     dec a
      00015C                        368     add_hl_a
      00015C                          1    add_REGPAIR_a  h, l
                                      1    ;; First Perform RH = E + A
      0008EE 85               [ 4]    2    add l    ;; [1] A' = RL + A 
      0008EF 6F               [ 4]    3    ld  l, a ;; [1] RL' = A' = RL + A. It might generate Carry that must be added to RH
                                      4    
                                      5    ;; Then Perform RH = RH + Carry 
      0008F0 8C               [ 4]    6    adc h    ;; [1] A'' = A' + RH + Carry = RL + A + RH + Carry
      0008F1 95               [ 4]    7    sub l    ;; [1] Remove RL'. A''' = A'' - RL' = RL + A + RH + Carry - (RL + A) = RH + Carry
      0008F2 67               [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
      0008F3                        369 draw_border2:
      0008F3 36 FF            [10]  370 	ld (hl), #0xff
      0008F5 18 08            [12]  371 	jr down_line
                                    372 
      0008F7                        373 draw_line:
      0008F7 36 FF            [10]  374 	ld (hl), #0xff
      0008F9 23               [ 6]  375 	inc hl
                                    376 	;;djnz draw_line
      0008FA 0D               [ 4]  377     dec c
      0008FB 79               [ 4]  378     ld a, c
      0008FC B7               [ 4]  379     or a
      0008FD 20 F8            [12]  380     jr nz, draw_line
                                    381 
      0008FF                        382 down_line:
      0008FF 3E 08            [ 7]  383 	ld a, #8          	    ;; [2] / HL = DE = DE + 0x800
      000901 82               [ 4]  384 	add d
      000902 67               [ 4]  385     ld h, a           	    ;; [1] | Adding 0x800 makes HL point to the start of
      000903 57               [ 4]  386 	ld d, a
      000904 6B               [ 4]  387 	ld l, e
                                    388 	
      000905 E6 38            [ 7]  389 	and   #0x38        	    ;; [2] leave out only bits 13,12 and 11 from new memory address (00xxx000 00000000)
      000907 C2 DC 08         [10]  390     jp    nz, next_line    	;; [3] If any bit from {13,12,11} is not 0, we are still inside 
...
Hexadecimal [24-Bits]
      ...
      00090A 21 50 C0         [10]  396     ld    hl, #0xC050       ;; [3] We advance destination pointer to next line
      00090D 19               [11]  397     add   hl, de            ;; [3] HL = DE + 0xC050
      00090E 54               [ 4]  398     ld     d, h             ;; [1] / DE = HL
      00090F 5D               [ 4]  399     ld     e, l             ;; [1] \
      000910 C3 DC 08         [10]  400     jp   next_line         	;; [3] Continue copying
                                    401 
      000913 C9               [10]  402     ret
      000914 00                     403 width: .db #0
      000915 00                     404 height: .db #0
      000916                        405 message_buffer: .ds 3000
