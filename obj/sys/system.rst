...
Hexadecimal [16-Bits]
   ...
   1B44 00                   32 nInterrupt:: .db 0
                             ...
                             46 ;;
   071A                      47 set_int_handler:
   071A 21 38 00      [10]   48 	ld hl, #0x38
   071D 36 C3         [10]   49 	ld (hl), #0xc3
   071F 23            [ 6]   50 	inc hl
   0720 36 2D         [10]   51 	ld (hl), #<int_handler1
   0722 23            [ 6]   52 	inc hl
   0723 36 07         [10]   53 	ld (hl), #>int_handler1
   0725 23            [ 6]   54 	inc hl
   0726 36 C9         [10]   55 	ld (hl), #0xc9
   000E                      56    m_reset_nInterrupt                           ;; reset number of interruption
   0728 AF            [ 4]    1     xor a
   0729 32 44 1B      [13]    2     ld (nInterrupt), a 
   072C C9            [10]   57 	ret
                             58 
                             59 
                             60 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             65 ;;
   072D                      66 int_handler1:
                             67    ;;cpctm_setBorder_asm HW_WHITE
   0013                      68    m_inc_nInterrupt                                ;;increment the number of interruption
   072D 3A 44 1B      [13]    1     ld a, (nInterrupt)
   0730 3C            [ 4]    2     inc a
   0731 32 44 1B      [13]    3     ld (nInterrupt), a 
   0734 21 3B 07      [10]   69 	ld hl, #int_handler2
   0737 CD 7F 17      [17]   70  	call cpct_setInterruptHandler_asm	
   073A C9            [10]   71 	ret
                             72 
                             73 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             74 ;;DESCRIPTION
...
Hexadecimal [16-Bits]
                             ...
                             78 ;;
   073B                      79 int_handler2:
                             80    ;;cpctm_setBorder_asm HW_RED
                             81 
   0021                      82    m_inc_nInterrupt                                ;;increment the number of interruption
   073B 3A 44 1B      [13]    1     ld a, (nInterrupt)
   073E 3C            [ 4]    2     inc a
   073F 32 44 1B      [13]    3     ld (nInterrupt), a 
                             83 
   0742 CD 33 19      [17]   84 	call cpct_scanKeyboard_if_asm
                             85 
                             86 
   0745 21 4C 07      [10]   87 	ld hl, #int_handler3
   0748 CD 7F 17      [17]   88    call cpct_setInterruptHandler_asm
   074B C9            [10]   89 	ret
                             90 
                             91 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             92 ;;DESCRIPTION
                             ...
                             96 ;;
   074C                      97 int_handler3:
                             98    ;;cpctm_setBorder_asm HW_GREEN
                             99 
   0032                     100    m_inc_nInterrupt                                ;;increment the number of interruption
   074C 3A 44 1B      [13]    1     ld a, (nInterrupt)
   074F 3C            [ 4]    2     inc a
   0750 32 44 1B      [13]    3     ld (nInterrupt), a 
                            101 
   0753 21 5A 07      [10]  102 	ld hl, #int_handler4
   0756 CD 7F 17      [17]  103    call cpct_setInterruptHandler_asm
   0759 C9            [10]  104 	ret
                            105 
                            106 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            107 ;;DESCRIPTION
                            ...
                            111 ;;
   075A                     112 int_handler4:
                            113    ;;cpctm_setBorder_asm HW_BLUE
                            114 
   0040                     115    m_inc_nInterrupt                                ;;increment the number of interruption
   075A 3A 44 1B      [13]    1     ld a, (nInterrupt)
   075D 3C            [ 4]    2     inc a
   075E 32 44 1B      [13]    3     ld (nInterrupt), a 
                            116 
   0761 21 68 07      [10]  117 	ld hl, #int_handler5
   0764 CD 7F 17      [17]  118    call cpct_setInterruptHandler_asm
   0767 C9            [10]  119 	ret
                            120 
                            121 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                            ...
                            126 ;;
   0768                     127 int_handler5:
                            128    ;;cpctm_setBorder_asm HW_ORANGE
                            129 
   004E                     130    m_inc_nInterrupt
   0768 3A 44 1B      [13]    1     ld a, (nInterrupt)
   076B 3C            [ 4]    2     inc a
   076C 32 44 1B      [13]    3     ld (nInterrupt), a 
                            131 
                            ...
                            146 ;;  ex af', af  
                            147 ;;  exx
   076F                     148 int_handler5_exit:
   076F 21 76 07      [10]  149 	ld hl, #int_handler6
   0772 CD 7F 17      [17]  150    call cpct_setInterruptHandler_asm
   0775 C9            [10]  151 	ret
                            152 
                            153 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            154 ;;DESCRIPTION
                            ...
                            158 ;;
   0776                     159 int_handler6:
                            160    ;;cpctm_setBorder_asm HW_PURPLE
                            161 
   005C                     162    m_reset_nInterrupt
   0776 AF            [ 4]    1     xor a
   0777 32 44 1B      [13]    2     ld (nInterrupt), a 
                            163 
   077A 21 2D 07      [10]  164 	ld hl, #int_handler1
   077D CD 7F 17      [17]  165    call cpct_setInterruptHandler_asm
   0780 C9            [10]  166 	ret
                            167 
                            168 
                            169 
...
Hexadecimal [16-Bits]
                            ...
                            177 ;;
   0781                     178 sys_system_disable_firmware::
   0781 CD B8 19      [17]  179    call cpct_disableFirmware_asm
   0784 21 2D 07      [10]  180    ld hl, #int_handler1
   0787 CD A8 19      [17]  181    call cpct_waitVSYNC_asm
   078A 76            [ 4]  182    halt
   078B 76            [ 4]  183    halt
   078C CD A8 19      [17]  184    call cpct_waitVSYNC_asm
   078F CD 7F 17      [17]  185    call cpct_setInterruptHandler_asm
                            186    
   0792 C9            [10]  187    ret
                            188 
                            189 
