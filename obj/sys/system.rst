...
Hexadecimal [24-Bits]
      ...
      001BD8 00                      32 nInterrupt:: .db 0
                                     ...
                                     46 ;;
      00151B                         47 set_int_handler:
      00151B 21 38 00         [10]   48 	ld hl, #0x38
      00151E 36 C3            [10]   49 	ld (hl), #0xc3
      001520 23               [ 6]   50 	inc hl
      001521 36 2E            [10]   51 	ld (hl), #<int_handler1
      001523 23               [ 6]   52 	inc hl
      001524 36 15            [10]   53 	ld (hl), #>int_handler1
      001526 23               [ 6]   54 	inc hl
      001527 36 C9            [10]   55 	ld (hl), #0xc9
      00000E                         56    m_reset_nInterrupt                           ;; reset number of interruption
      001529 AF               [ 4]    1     xor a
      00152A 32 D8 1B         [13]    2     ld (nInterrupt), a 
      00152D C9               [10]   57 	ret
                                     58 
                                     59 
                                     60 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     ...
                                     65 ;;
      00152E                         66 int_handler1:
                                     67    ;;cpctm_setBorder_asm HW_WHITE
      000013                         68    m_inc_nInterrupt                                ;;increment the number of interruption
      00152E 3A D8 1B         [13]    1     ld a, (nInterrupt)
      001531 3C               [ 4]    2     inc a
      001532 32 D8 1B         [13]    3     ld (nInterrupt), a 
      001535 21 3C 15         [10]   69 	ld hl, #int_handler2
      001538 CD 81 17         [17]   70  	call cpct_setInterruptHandler_asm	
      00153B C9               [10]   71 	ret
                                     72 
                                     73 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     74 ;;DESCRIPTION
...
Hexadecimal [24-Bits]
                                     ...
                                     78 ;;
      00153C                         79 int_handler2:
                                     80    ;;cpctm_setBorder_asm HW_RED
                                     81 
      000021                         82    m_inc_nInterrupt                                ;;increment the number of interruption
      00153C 3A D8 1B         [13]    1     ld a, (nInterrupt)
      00153F 3C               [ 4]    2     inc a
      001540 32 D8 1B         [13]    3     ld (nInterrupt), a 
                                     83 
      001543 CD 35 19         [17]   84 	call cpct_scanKeyboard_if_asm
                                     85 
                                     86 
      001546 21 4D 15         [10]   87 	ld hl, #int_handler3
      001549 CD 81 17         [17]   88    call cpct_setInterruptHandler_asm
      00154C C9               [10]   89 	ret
                                     90 
                                     91 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     92 ;;DESCRIPTION
                                     ...
                                     96 ;;
      00154D                         97 int_handler3:
                                     98    ;;cpctm_setBorder_asm HW_GREEN
                                     99 
      000032                        100    m_inc_nInterrupt                                ;;increment the number of interruption
      00154D 3A D8 1B         [13]    1     ld a, (nInterrupt)
      001550 3C               [ 4]    2     inc a
      001551 32 D8 1B         [13]    3     ld (nInterrupt), a 
                                    101 
      001554 21 5B 15         [10]  102 	ld hl, #int_handler4
      001557 CD 81 17         [17]  103    call cpct_setInterruptHandler_asm
      00155A C9               [10]  104 	ret
                                    105 
                                    106 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    107 ;;DESCRIPTION
                                    ...
                                    111 ;;
      00155B                        112 int_handler4:
                                    113    ;;cpctm_setBorder_asm HW_BLUE
                                    114 
      000040                        115    m_inc_nInterrupt                                ;;increment the number of interruption
      00155B 3A D8 1B         [13]    1     ld a, (nInterrupt)
      00155E 3C               [ 4]    2     inc a
      00155F 32 D8 1B         [13]    3     ld (nInterrupt), a 
                                    116 
      001562 21 69 15         [10]  117 	ld hl, #int_handler5
      001565 CD 81 17         [17]  118    call cpct_setInterruptHandler_asm
      001568 C9               [10]  119 	ret
                                    120 
                                    121 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [24-Bits]
                                    ...
                                    126 ;;
      001569                        127 int_handler5:
                                    128    ;;cpctm_setBorder_asm HW_ORANGE
                                    129 
      00004E                        130    m_inc_nInterrupt
      001569 3A D8 1B         [13]    1     ld a, (nInterrupt)
      00156C 3C               [ 4]    2     inc a
      00156D 32 D8 1B         [13]    3     ld (nInterrupt), a 
                                    131 
                                    ...
                                    146 ;;  ex af', af  
                                    147 ;;  exx
      001570                        148 int_handler5_exit:
      001570 21 77 15         [10]  149 	ld hl, #int_handler6
      001573 CD 81 17         [17]  150    call cpct_setInterruptHandler_asm
      001576 C9               [10]  151 	ret
                                    152 
                                    153 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                    154 ;;DESCRIPTION
                                    ...
                                    158 ;;
      001577                        159 int_handler6:
                                    160    ;;cpctm_setBorder_asm HW_PURPLE
                                    161 
      00005C                        162    m_reset_nInterrupt
      001577 AF               [ 4]    1     xor a
      001578 32 D8 1B         [13]    2     ld (nInterrupt), a 
                                    163 
      00157B 21 2E 15         [10]  164 	ld hl, #int_handler1
      00157E CD 81 17         [17]  165    call cpct_setInterruptHandler_asm
      001581 C9               [10]  166 	ret
                                    167 
                                    168 
                                    169 
                                    170 ;;-----------------------------------------------------------------
...
Hexadecimal [24-Bits]
                                    ...
                                    177 ;;
      001582                        178 sys_system_disable_firmware::
      001582 CD BA 19         [17]  179    call cpct_disableFirmware_asm
      001585 21 2E 15         [10]  180    ld hl, #int_handler1
      001588 CD AA 19         [17]  181    call cpct_waitVSYNC_asm
      00158B 76               [ 4]  182    halt
      00158C 76               [ 4]  183    halt
      00158D CD AA 19         [17]  184    call cpct_waitVSYNC_asm
      001590 CD 81 17         [17]  185    call cpct_setInterruptHandler_asm
                                    186    
      001593 C9               [10]  187    ret
                                    188 
                                    189 
