...
Hexadecimal [24-Bits]
                                     ...
                                     32 
                                     33 
      001BBA                         34 sys_input_main_menu_actions::
      ...
      001BBA 00 00                   47     .dw 0
                                     ...
                                     62 ;;  Modified: 
                                     63 ;;
      00071C                         64 sys_input_clean_buffer::
      00071C CD 28 19         [17]   65     call cpct_isAnyKeyPressed_asm
      00071F 20 FB            [12]   66     jr nz, sys_input_clean_buffer
      000721 C9               [10]   67     ret
                                     68 
                                     69 ;;-----------------------------------------------------------------
                                     70 ;;
...
Hexadecimal [24-Bits]
      ...
      000722                         78 sys_input_wait4anykey::
      000722 21 00 00         [10]   79     ld hl, #0
      000725                         80 _siw_loop:
      000725 E5               [11]   81     push hl
      000726 CD 28 19         [17]   82     call cpct_isAnyKeyPressed_asm
      000729 B7               [ 4]   83     or a
      00072A E1               [10]   84     pop hl
      00072B 23               [ 6]   85     inc hl
      00072C 28 F7            [12]   86     jr z, _siw_loop
      00072E C9               [10]   87     ret
                                     88 
                                     89 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     90 ;; DESCRIPTION
                                    ...
                                    104 ;;
      00072F                        105 sys_input_getKeyPressed::
      00072F 21 93 18         [10]  106     ld hl, #_cpct_keyboardStatusBuffer
      000732 AF               [ 4]  107     xor a                           ;; A = 0
                                    108 
      000733                        109 _kp_loop:
      000733 FE 0A            [ 7]  110     cp #BUFFER_SIZE
      000735 28 14            [12]  111     jr z, _kp_endLoop               ;; Check counter value. End if its 0
      000737 32 47 07         [13]  112     ld (_size_counter), a
                                    113 
      00073A 7E               [ 7]  114     ld a, (hl)                      ;; Load byte from the buffer
      00073B EE FF            [ 7]  115     xor #ZERO_KEYS_ACTIVATED        ;; Inverts bytes
      00073D 28 06            [12]  116     jr z, _no_key_detected
      00073F 67               [ 4]  117         ld h, a                     ;; H is the mask
      000740 3A 47 07         [13]  118         ld a, (_size_counter)
      000743 6F               [ 4]  119         ld l, a                     ;; L is the offset
                                    120         ; ld (_current_key_pressed), hl
      000744 C9               [10]  121         ret
      000745                        122 _no_key_detected:
      000745 23               [ 6]  123     inc hl
                           00002B   124 _size_counter = .+1
      000746 3E 00            [ 7]  125     ld a, #0x00                     ;; AUTOMODIFIABLE, A = counter
      000748 3C               [ 4]  126     inc a
      000749 18 E8            [12]  127     jr _kp_loop
      00074B                        128 _kp_endLoop:
      00074B 21 00 00         [10]  129     ld hl, #0x00                    ;; Return 0 if no key is pressed
      00074E 3E 00            [ 7]  130     ld a, #0
      000750 32 54 07         [13]  131     ld (_key_released), a
      000753 C9               [10]  132     ret
...
Hexadecimal [24-Bits]
      ...
      000754 00                     135     .db #0
                                    ...
                                    152 ;;
      000755                        153 sys_input_waitKeyPressed::
      000755 CD 2F 07         [17]  154     call sys_input_getKeyPressed
      000758 3A 54 07         [13]  155     ld a, (_key_released)
      00075B B7               [ 4]  156     or a
      00075C 20 F7            [12]  157     jr nz, sys_input_waitKeyPressed
      00075E AF               [ 4]  158     xor a
      00075F B4               [ 4]  159     or h
      000760 B5               [ 4]  160     or l
      000761 28 F2            [12]  161     jr z, sys_input_waitKeyPressed
      000763 3E 01            [ 7]  162     ld a, #1
      000765 32 54 07         [13]  163     ld (_key_released), a
      000768 C9               [10]  164     ret
                                    165 
                                    166 
                                    167 ;;-----------------------------------------------------------------
                                    168 ;;
                                    ...
                                    174 ;;  Modified: 
                                    175 ;;
      000769                        176 sys_input_init::
      000769 C9               [10]  177     ret 
                                    178 
                                    179 ;;-----------------------------------------------------------------
                                    180 ;;
...
Hexadecimal [24-Bits]
                                    ...
                                    188 ;;
      00076A                        189 sys_input_generic_update:
      00076A 18 05            [12]  190     jr first_key
      00076C                        191 keys_loop:
      00076C 01 04 00         [10]  192     ld bc, #4
      00076F FD 09            [15]  193     add iy, bc
      000771                        194 first_key:
      000771 FD 6E 00         [19]  195     ld l, 0(iy)                     ;; Lower part of the key pointer
      000774 FD 66 01         [19]  196     ld h, 1(iy)                     ;; Lower part of the key pointer
                                    197     ;; Check if key is null
      000777 7D               [ 4]  198     ld a, l
      000778 B4               [ 4]  199     or h
      000779 C8               [11]  200     ret z                           ;; Return if key is null
                                    201     ;; Check if key is pressed
      00077A CD DD 17         [17]  202     call cpct_isKeyPressed_asm      ;;
      00077D 28 ED            [12]  203     jr z, keys_loop
                                    204     ;; Key pressed execute action
      00077F 21 6C 07         [10]  205     ld hl, #keys_loop               ;;
      000782 E5               [11]  206     push hl                         ;; return addres from executed function
      000783 FD 6E 02         [19]  207     ld l, 2(iy)                     ;;
      000786 FD 66 03         [19]  208     ld h, 3(iy)                     ;; retrieve function address    
      000789 E9               [ 4]  209     jp (hl)                         ;; jump to function
                                    210 
                                    211 
                                    212 ;;-----------------------------------------------------------------
                                    213 ;;
                                    ...
                                    219 ;;  Modified: iy, bc
                                    220 ;;
      00078A                        221 sys_input_main_menu_update::
      00078A FD 21 BA 1B      [14]  222     ld iy, #sys_input_main_menu_actions
      00078E CD 6A 07         [17]  223     call sys_input_generic_update
      000791 C9               [10]  224     ret
                                    225 
                                    226 
                                    227 
                                    228 
