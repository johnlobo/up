...
Hexadecimal [16-Bits]
                             ...
                             32 
                             33 
   1B80                      34 sys_input_main_menu_actions::
   ...
   1B80 00 00                47     .dw 0
                             ...
                             62 ;;  Modified: 
                             63 ;;
   1709                      64 sys_input_clean_buffer::
   1709 CD 26 19      [17]   65     call cpct_isAnyKeyPressed_asm
   170C 20 FB         [12]   66     jr nz, sys_input_clean_buffer
   170E C9            [10]   67     ret
                             68 
                             69 ;;-----------------------------------------------------------------
                             70 ;;
...
Hexadecimal [16-Bits]
   ...
   170F                      78 sys_input_wait4anykey::
   170F 21 00 00      [10]   79     ld hl, #0
   1712                      80 _siw_loop:
   1712 E5            [11]   81     push hl
   1713 CD 26 19      [17]   82     call cpct_isAnyKeyPressed_asm
   1716 B7            [ 4]   83     or a
   1717 E1            [10]   84     pop hl
   1718 23            [ 6]   85     inc hl
   1719 28 F7         [12]   86     jr z, _siw_loop
   171B C9            [10]   87     ret
                             88 
                             89 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             90 ;; DESCRIPTION
                            ...
                            104 ;;
   171C                     105 sys_input_getKeyPressed::
   171C 21 91 18      [10]  106     ld hl, #_cpct_keyboardStatusBuffer
   171F AF            [ 4]  107     xor a                           ;; A = 0
                            108 
   1720                     109 _kp_loop:
   1720 FE 0A         [ 7]  110     cp #BUFFER_SIZE
   1722 28 14         [12]  111     jr z, _kp_endLoop               ;; Check counter value. End if its 0
   1724 32 34 17      [13]  112     ld (_size_counter), a
                            113 
   1727 7E            [ 7]  114     ld a, (hl)                      ;; Load byte from the buffer
   1728 EE FF         [ 7]  115     xor #ZERO_KEYS_ACTIVATED        ;; Inverts bytes
   172A 28 06         [12]  116     jr z, _no_key_detected
   172C 67            [ 4]  117         ld h, a                     ;; H is the mask
   172D 3A 34 17      [13]  118         ld a, (_size_counter)
   1730 6F            [ 4]  119         ld l, a                     ;; L is the offset
                            120         ; ld (_current_key_pressed), hl
   1731 C9            [10]  121         ret
   1732                     122 _no_key_detected:
   1732 23            [ 6]  123     inc hl
                     002B   124 _size_counter = .+1
   1733 3E 00         [ 7]  125     ld a, #0x00                     ;; AUTOMODIFIABLE, A = counter
   1735 3C            [ 4]  126     inc a
   1736 18 E8         [12]  127     jr _kp_loop
   1738                     128 _kp_endLoop:
   1738 21 00 00      [10]  129     ld hl, #0x00                    ;; Return 0 if no key is pressed
   173B 3E 00         [ 7]  130     ld a, #0
   173D 32 41 17      [13]  131     ld (_key_released), a
   1740 C9            [10]  132     ret
...
Hexadecimal [16-Bits]
   ...
   1741 00                  135     .db #0
                            ...
                            152 ;;
   1742                     153 sys_input_waitKeyPressed::
   1742 CD 1C 17      [17]  154     call sys_input_getKeyPressed
   1745 3A 41 17      [13]  155     ld a, (_key_released)
   1748 B7            [ 4]  156     or a
   1749 20 F7         [12]  157     jr nz, sys_input_waitKeyPressed
   174B AF            [ 4]  158     xor a
   174C B4            [ 4]  159     or h
   174D B5            [ 4]  160     or l
   174E 28 F2         [12]  161     jr z, sys_input_waitKeyPressed
   1750 3E 01         [ 7]  162     ld a, #1
   1752 32 41 17      [13]  163     ld (_key_released), a
   1755 C9            [10]  164     ret
                            165 
                            166 
                            167 ;;-----------------------------------------------------------------
...
Hexadecimal [16-Bits]
                            ...
                            188 ;;
   1757                     189 sys_input_generic_update:
   1757 18 05         [12]  190     jr first_key
   1759                     191 keys_loop:
   1759 01 04 00      [10]  192     ld bc, #4
   175C FD 09         [15]  193     add iy, bc
   175E                     194 first_key:
   175E FD 6E 00      [19]  195     ld l, 0(iy)                     ;; Lower part of the key pointer
   1761 FD 66 01      [19]  196     ld h, 1(iy)                     ;; Lower part of the key pointer
                            197     ;; Check if key is null
   1764 7D            [ 4]  198     ld a, l
   1765 B4            [ 4]  199     or h
   1766 C8            [11]  200     ret z                           ;; Return if key is null
                            201     ;; Check if key is pressed
   1767 CD DB 17      [17]  202     call cpct_isKeyPressed_asm      ;;
   176A 28 ED         [12]  203     jr z, keys_loop
                            204     ;; Key pressed execute action
   176C 21 59 17      [10]  205     ld hl, #keys_loop               ;;
   176F E5            [11]  206     push hl                         ;; return addres from executed function
   1770 FD 6E 02      [19]  207     ld l, 2(iy)                     ;;
   1773 FD 66 03      [19]  208     ld h, 3(iy)                     ;; retrieve function address    
   1776 E9            [ 4]  209     jp (hl)                         ;; jump to function
                            210 
                            211 
                            212 ;;-----------------------------------------------------------------
                            213 ;;
                            ...
                            219 ;;  Modified: iy, bc
                            220 ;;
   1777                     221 sys_input_main_menu_update::
   1777 FD 21 80 1B   [14]  222     ld iy, #sys_input_main_menu_actions
   177B CD 57 17      [17]  223     call sys_input_generic_update
   177E C9            [10]  224     ret
                            225 
                            226 
                            227 
