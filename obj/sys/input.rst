...
Hexadecimal [24-Bits]
                                     ...
                                     32 
                                     33 
      001997                         34 sys_input_main_menu_actions::
      ...
      001997 00 00                   47     .dw 0
                                     ...
                                     62 ;;  Modified: 
                                     63 ;;
      0005EC                         64 sys_input_clean_buffer::
      0005EC CD 82 17         [17]   65     call cpct_isAnyKeyPressed_asm
      0005EF 20 FB            [12]   66     jr nz, sys_input_clean_buffer
      0005F1 C9               [10]   67     ret
                                     68 
                                     69 ;;-----------------------------------------------------------------
                                     70 ;;
...
Hexadecimal [24-Bits]
      ...
      0005F2                         78 sys_input_wait4anykey::
      0005F2 21 00 00         [10]   79     ld hl, #0
      0005F5                         80 _siw_loop:
      0005F5 E5               [11]   81     push hl
      0005F6 CD 82 17         [17]   82     call cpct_isAnyKeyPressed_asm
      0005F9 B7               [ 4]   83     or a
      0005FA E1               [10]   84     pop hl
      0005FB 23               [ 6]   85     inc hl
      0005FC 28 F7            [12]   86     jr z, _siw_loop
      0005FE C9               [10]   87     ret
                                     88 
                                     89 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                                     90 ;; DESCRIPTION
                                    ...
                                    104 ;;
      0005FF                        105 sys_input_getKeyPressed::
      0005FF 21 63 17         [10]  106     ld hl, #_cpct_keyboardStatusBuffer
      000602 AF               [ 4]  107     xor a                           ;; A = 0
                                    108 
      000603                        109 _kp_loop:
      000603 FE 0A            [ 7]  110     cp #BUFFER_SIZE
      000605 28 14            [12]  111     jr z, _kp_endLoop               ;; Check counter value. End if its 0
      000607 32 17 06         [13]  112     ld (_size_counter), a
                                    113 
      00060A 7E               [ 7]  114     ld a, (hl)                      ;; Load byte from the buffer
      00060B EE FF            [ 7]  115     xor #ZERO_KEYS_ACTIVATED        ;; Inverts bytes
      00060D 28 06            [12]  116     jr z, _no_key_detected
      00060F 67               [ 4]  117         ld h, a                     ;; H is the mask
      000610 3A 17 06         [13]  118         ld a, (_size_counter)
      000613 6F               [ 4]  119         ld l, a                     ;; L is the offset
                                    120         ; ld (_current_key_pressed), hl
      000614 C9               [10]  121         ret
      000615                        122 _no_key_detected:
      000615 23               [ 6]  123     inc hl
                           00002B   124 _size_counter = .+1
      000616 3E 00            [ 7]  125     ld a, #0x00                     ;; AUTOMODIFIABLE, A = counter
      000618 3C               [ 4]  126     inc a
      000619 18 E8            [12]  127     jr _kp_loop
      00061B                        128 _kp_endLoop:
      00061B 21 00 00         [10]  129     ld hl, #0x00                    ;; Return 0 if no key is pressed
      00061E 3E 00            [ 7]  130     ld a, #0
      000620 32 24 06         [13]  131     ld (_key_released), a
      000623 C9               [10]  132     ret
...
Hexadecimal [24-Bits]
      ...
      000624 00                     135     .db #0
                                    ...
                                    152 ;;
      000625                        153 sys_input_waitKeyPressed::
      000625 CD FF 05         [17]  154     call sys_input_getKeyPressed
      000628 3A 24 06         [13]  155     ld a, (_key_released)
      00062B B7               [ 4]  156     or a
      00062C 20 F7            [12]  157     jr nz, sys_input_waitKeyPressed
      00062E AF               [ 4]  158     xor a
      00062F B4               [ 4]  159     or h
      000630 B5               [ 4]  160     or l
      000631 28 F2            [12]  161     jr z, sys_input_waitKeyPressed
      000633 3E 01            [ 7]  162     ld a, #1
      000635 32 24 06         [13]  163     ld (_key_released), a
      000638 C9               [10]  164     ret
                                    165 
                                    166 
                                    167 ;;-----------------------------------------------------------------
                                    168 ;;
                                    ...
                                    174 ;;  Modified: 
                                    175 ;;
      000639                        176 sys_input_init::
      000639 C9               [10]  177     ret 
                                    178 
                                    179 ;;-----------------------------------------------------------------
                                    180 ;;
...
Hexadecimal [24-Bits]
                                    ...
                                    188 ;;
      00063A                        189 sys_input_generic_update:
      00063A 18 05            [12]  190     jr first_key
      00063C                        191 keys_loop:
      00063C 01 04 00         [10]  192     ld bc, #4
      00063F FD 09            [15]  193     add iy, bc
      000641                        194 first_key:
      000641 FD 6E 00         [19]  195     ld l, 0(iy)                     ;; Lower part of the key pointer
      000644 FD 66 01         [19]  196     ld h, 1(iy)                     ;; Lower part of the key pointer
                                    197     ;; Check if key is null
      000647 7D               [ 4]  198     ld a, l
      000648 B4               [ 4]  199     or h
      000649 C8               [11]  200     ret z                           ;; Return if key is null
                                    201     ;; Check if key is pressed
      00064A CD AD 16         [17]  202     call cpct_isKeyPressed_asm      ;;
      00064D 28 ED            [12]  203     jr z, keys_loop
                                    204     ;; Key pressed execute action
      00064F 21 3C 06         [10]  205     ld hl, #keys_loop               ;;
      000652 E5               [11]  206     push hl                         ;; return addres from executed function
      000653 FD 6E 02         [19]  207     ld l, 2(iy)                     ;;
      000656 FD 66 03         [19]  208     ld h, 3(iy)                     ;; retrieve function address    
      000659 E9               [ 4]  209     jp (hl)                         ;; jump to function
                                    210 
                                    211 
                                    212 ;;-----------------------------------------------------------------
                                    213 ;;
                                    ...
                                    219 ;;  Modified: iy, bc
                                    220 ;;
      00065A                        221 sys_input_main_menu_update::
      00065A FD 21 97 19      [14]  222     ld iy, #sys_input_main_menu_actions
      00065E CD 3A 06         [17]  223     call sys_input_generic_update
      000661 C9               [10]  224     ret
                                    225 
                                    226 
                                    227 
                                    228 
