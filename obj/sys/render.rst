...
Hexadecimal [24-Bits]
                                     ...
                                     29 .area _DATA
                                     30 
      001BD3 00 00                   31 FONT_NUMBERS: .dw #0000
                                     32 
      001BD5 C0                      33 sys_render_front_buffer: .db 0xc0
      001BD6 80                      34 sys_render_back_buffer: .db 0x80
      001BD7 00                      35 sys_render_touched_zones: .db 0x00
                                     36 
                                     37 .area _ABS   (ABS)
      000100                         38 .org 0x100
...
Hexadecimal [24-Bits]
      ...
      0001F8 00 00 00 00 00 00 00    71         .db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
             00
                                     ...
                                     86 ;;====================================================
      0014CE                         87 sys_render_clear_buffer::
      0014CE 36 00            [10]   88     ld (hl), #0
      0014D0 54               [ 4]   89     ld d, h
      0014D1 5D               [ 4]   90     ld e, l
      0014D2 13               [ 6]   91     inc de
      0014D3 01 FF 3F         [10]   92     ld bc, #0x4000-1
                                     93 
      0014D6 ED B0            [21]   94     ldir
      0014D8 C9               [10]   95 ret
                                     96 
                                     97 ;;====================================================
...
Hexadecimal [24-Bits]
                                    ...
                                    105 ;;====================================================
      0014D9                        106 sys_render_clear_back_buffer::
      0014D9 3A D6 1B         [13]  107     ld a, (sys_render_back_buffer)
      0014DC 67               [ 4]  108     ld h, a
      0014DD 2E 00            [ 7]  109     ld l, #0
      0014DF CD CE 14         [17]  110     call sys_render_clear_buffer
      0014E2 C9               [10]  111     ret
                                    112 
                                    113 ;;====================================================
                                    ...
                                    121 ;;====================================================
      0014E3                        122 sys_render_clear_front_buffer::
      0014E3 3A D5 1B         [13]  123     ld a, (sys_render_front_buffer)
      0014E6 67               [ 4]  124     ld h, a
      0014E7 2E 00            [ 7]  125     ld l, #0
      0014E9 CD CE 14         [17]  126     call sys_render_clear_buffer
      0014EC C9               [10]  127     ret
                                    128 
                                    129 
                                    130 
                                    131 ;;====================================================
                                    ...
                                    140 ;;====================================================
      0014ED                        141 sys_render_switch_buffers::
      0014ED 2A D5 1B         [16]  142     ld hl, (sys_render_front_buffer)    ;; Inicialmente (80C0)
      0014F0 7D               [ 4]  143     ld a, l                             ;; Carga el front buffer en el back buffer
      0014F1 32 D6 1B         [13]  144     ld (sys_render_back_buffer) , a
      0014F4 7C               [ 4]  145     ld a, h                             ;; Carga el back buffer en el front buffer
      0014F5 32 D5 1B         [13]  146     ld (sys_render_front_buffer), a
      0014F8 CB 3F            [ 8]  147     srl a
      0014FA CB 3F            [ 8]  148     srl a
      0014FC 6F               [ 4]  149     ld l, a
      0014FD CD AA 19         [17]  150     call cpct_waitVSYNC_asm
      001500 C3 B4 18         [10]  151     jp cpct_setVideoMemoryPage_asm
                                    152 
                                    153 
...
Hexadecimal [24-Bits]
                                    ...
                                    162 ;;
      001503                        163 sys_render_init::
                                    164     
      001503 0E 00            [ 7]  165     ld c,#0                                 ;; Set video mode
      001505 CD 9D 19         [17]  166     call cpct_setVideoMode_asm              ;;
                                    167     
      001508 21 B2 05         [10]  168     ld hl, #_g_palette0                     ;; Set palette
      00150B 11 10 00         [10]  169     ld de, #16                              ;;
      00150E CD CA 17         [17]  170     call cpct_setPalette_asm                ;;
                                    171 
      ...
      001511 21 10 14         [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
      001514 CD E9 17         [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                                      3    .radix d
                                    173     ;;cpctm_setBorder_asm HW_WHITE            ;; Set Border
                                    174 
                                    175     ;;call sys_render_clear_back_buffer
      001517 CD E3 14         [17]  176     call sys_render_clear_front_buffer
                                    177 
                                    178     ;;cpctm_clearScreen_asm 0                 ;; Clear screen
                                    179 
      00151A C9               [10]  180     ret
