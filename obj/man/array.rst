...
Hexadecimal [16-Bits]
                             ...
                             30 ;;
                             31 .area _DATA
   1E3C 00 00                32 routine:        .dw #0000
   1E3E 00                   33 comp_size:      .db #0
   1E3F 00                   34 comp_type:      .db #0
   1E40 00 00                35 routine_iY:     .dw #0000
   1E42 00                   36 comp_size_iY:   .db #0
   1E43 00                   37 comp_type_iY:   .db #0
                             38 
                             39 
                             40 ;;
...
Hexadecimal [16-Bits]
   ...
   0921 CD FB 0A      [17]  232     call sys_util_get_random_number
...
Hexadecimal [16-Bits]
   ...
   095E 47            [ 4]  298     ld b, a                 ;; move the number of elements to b for indexing djnz
                            299 
   095F 22 3C 1E      [16]  300     ld (routine), hl        ;; store routine in memory
                            301 
   0962 DD 7E 02      [19]  302     ld a, a_component_size(ix)  ;; store component_size in memory
   0965 32 3E 1E      [13]  303     ld (comp_size), a       ;;    
                            304     
...
Hexadecimal [16-Bits]
   ...
   0987 32 3F 1E      [13]  346     ld (comp_type), a       ;; save component to match for later
                            347 
   ...
   098F 47            [ 4]  352     ld b, a                 ;; move the number of elements to b for indexing djnz
                            353 
   0990 22 3C 1E      [16]  354     ld (routine), hl        ;; store routine in memory
                            355 
   0993 DD 7E 02      [19]  356     ld a, a_component_size(ix)  ;; store component_size in memory
   0996 32 3E 1E      [13]  357     ld (comp_size), a       ;;    
                            358     
   ...
   099F C5            [11]  365     push bc                 ;; save index in stack
                            366 
   09A0 3A 3F 1E      [13]  367     ld a, (comp_type)       ;; Retrieve the component type to match
