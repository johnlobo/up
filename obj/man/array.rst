...
Hexadecimal [24-Bits]
                                     ...
                                     52 ;;===============================================================================
      0005EA                         53 BeginStruct a
                           000000     1     a_offset = 0
      000000                         54 Field a, count , 1
                           000000     1     a_count = a_offset
                           000001     2     a_offset = a_offset + 1
      000000                         55 Field a, delta , 1
                           000001     1     a_delta = a_offset
                           000002     2     a_offset = a_offset + 1
      000000                         56 Field a, component_size , 1
                           000002     1     a_component_size = a_offset
                           000003     2     a_offset = a_offset + 1
      000000                         57 Field a, pend , 2
                           000003     1     a_pend = a_offset
                           000005     2     a_offset = a_offset + 2
      000000                         58 Field a, selected , 1
                           000005     1     a_selected = a_offset
                           000006     2     a_offset = a_offset + 1
      000000                         59 Field a, array , 1
                           000006     1     a_array = a_offset
                           000007     2     a_offset = a_offset + 1
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 7.
Hexadecimal [24-Bits]



      000000                         60 EndStruct a
                           000007     1     sizeof_a = a_offset
...
Hexadecimal [24-Bits]
                                     ...
                                     42 ;; man_array_init
                                     43 ;;
                                     44 ;;  Initilizes an array
                                     45 ;;  Input: ix points to the array
                                     46 ;;  Output: 
                                     47 ;;  Modified: AF, HL
                                     48 ;;
      000000                         49 man_array_init::
      0005EA AF               [ 4]   50     xor a
      0005EB DD 77 00         [19]   51     ld a_count(ix), a           ;; Initialize the number of elements in the array
                                     52 
      000004                         53     ld__hl_ix                   ;; point hl to the start of the array 
                                      1    ;; LD HL, IX
                                      2    ;;------------
      000004                          3    ld__a_ixl
      ...
      0005F3 67               [ 4]    6    ld  h, a
                                      7    ;;------------
      0005F4 3E 06            [ 7]   54     ld a, #a_array
      00000C                         55     add_hl_a
      ...
      0005FA 67               [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
                                     56     
      0005FB DD 75 03         [19]   57     ld a_pend(ix), l            ;; load pointer to the end in hl
      0005FE DD 74 04         [19]   58     ld a_pend+1(ix), h
                                     59 
      000601 36 00            [10]   60     ld  (hl), #e_type_invalid   ;;ponemos el primer elemento del array con tipo invalido
...
Hexadecimal [24-Bits]
      ...
      000603 C9               [10]   61     ret
                                     ...
                                     64 ;;-----------------------------------------------------------------
                                     65 ;;
                                     66 ;; man_array_create_element
                                     67 ;;
                                     68 ;;  Create a card from the model pointed by HL
                                     69 ;;  Input:  ix: pointer to the array 
                                     70 ;;          hl: pointer to the entity to add to the array
                                     71 ;;  Output: hl: points to the new created entity
                                     72 ;;  Modified: AF, BC, DE, HL
                                     73 ;;
      000604                         74 man_array_create_element::
      000604 06 00            [ 7]   75     ld b, #0                        ;; bc = component size
      000606 DD 7E 02         [19]   76     ld a, a_component_size(ix)      ;;
      000609 4F               [ 4]   77     ld c, a                         ;;    
      00060A 32 24 06         [13]   78     ld (_create_size), a            ;; self modifying code to move the size of the entity to bc
      00060D AF               [ 4]   79     xor a                           ;; ld a, #0
      00060E 32 25 06         [13]   80     ld (_create_size+1), a          ;;
                                     81     
      000611 DD 5E 03         [19]   82     ld e, a_pend(ix)                ;; Load the address of the next element in de
      000614 DD 56 04         [19]   83     ld d, a_pend+1(ix)              ;;
      000617 D5               [11]   84     push de                         ;; Store the address of the next element to return it at the end
      000618 ED B0            [21]   85     ldir                            ;; de=pend, bc=component_size, hl=pointer to the entity to be added
                                     86 
      00061A DD 34 00         [23]   87     inc a_count(ix)                 ;; increase the number of entities
                                     88 
      00061D DD 6E 03         [19]   89     ld l, a_pend(ix)                ;; load in hl the pointer to the next entity
      000620 DD 66 04         [19]   90     ld h, a_pend+1(ix)
                           00003A    91 _create_size = .+1
      000623 01 00 00         [10]   92     ld   bc, #00
      000626 09               [11]   93     add  hl, bc
                                     94 
      000627 DD 75 03         [19]   95     ld   a_pend(ix), l              ;; update the pointer to the next entity
      00062A DD 74 04         [19]   96     ld   a_pend+1(ix), h            ;;
                                     97 
      00062D E1               [10]   98     pop hl                          ;; restore the new element address in hl
      00062E C9               [10]   99 ret
                                    100 
                                    101 
                                    102 
                                    ...
                                    104 ;;-----------------------------------------------------------------
                                    105 ;;
                                    106 ;; man_array_remove_element
                                    107 ;;
                                    108 ;;  Remove a element pointed by a from the array
                                    109 ;;  Input: a: number of element to remove
                                    110 ;;  Output: 
                                    111 ;;  Modified: AF, BC, DE, HL
                                    112 ;;
      00062F                        113 man_array_remove_element::
                                    114 
      00062F 47               [ 4]  115     ld b, a                     ;; copy element to erase to b
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 107.
Hexadecimal [24-Bits]



      000630 DD 7E 00         [19]  116     ld a, a_count(ix)           ;; check if we have to erase the last element
      000633 3D               [ 4]  117     dec a                       ;;
      000634 B8               [ 4]  118     cp b                        ;;
      000635 28 2F            [12]  119     jr z, _last_element         ;;  jump if we have to erase the last element
                                    120 
      000637 DD E5            [15]  121     push ix                     ;; hl to the start of the array    
      000639 E1               [10]  122     pop hl                      ;;
      00063A 11 06 00         [10]  123     ld de, #a_array             ;;
      00063D 19               [11]  124     add hl, de                  ;;
                                    125 
      00063E 78               [ 4]  126     ld a, b                     ;; restore a value from b
      00063F B7               [ 4]  127     or a                        ;; if we have to erase the first element we are don with hl
      000640 CA 4B 06         [10]  128     jp z, _calc_end_of_element  ;; 
                                    129 
      000643 16 00            [ 7]  130     ld d, #0                 ;; copy the size of an entity in de
      000645 DD 5E 02         [19]  131     ld e, a_component_size(ix)  ;;
      000648                        132 _start_loop:                    ;;
      000648 19               [11]  133     add hl, de                  ;; hl advance a card
      000649 10 FD            [13]  134     djnz _start_loop            ;; hl points to the start of the element to remove
                                    135 
      00064B                        136 _calc_end_of_element:
      00064B 54               [ 4]  137     ld d, h                     ;; copy hl in de-> de=start of the element to remove
      00064C 5D               [ 4]  138     ld e, l                     ;;
                                    139 
      00064D 06 00            [ 7]  140     ld b, #0                    ;; add size of an element to hl
      00064F DD 4E 02         [19]  141     ld c, a_component_size(ix)  ;; 
      000652 09               [11]  142     add hl,bc                   ;; hl= end of the element to remove
                                    143 
      000653 D5               [11]  144     push de                     ;; save de
      000654 E5               [11]  145     push hl                     ;; save hl
      000655 EB               [ 4]  146     ex de, hl                   ;; we have in de the end of the element to remove
                                    147 
      000656 DD 6E 03         [19]  148     ld l, a_pend(ix)            ;; calculate the amount of data to move
      000659 DD 66 04         [19]  149     ld h, a_pend+1(ix)          ;; 
      00065C ED 52            [15]  150     sbc hl, de                  ;;
      00065E 44               [ 4]  151     ld b, h                     ;; move hl to bc
      00065F 4D               [ 4]  152     ld c, l                     ;; bc = size of data to move
                                    153 
      000660 E1               [10]  154     pop hl                      ;; restore hl
      000661 D1               [10]  155     pop de                      ;; restore de
                                    156 
      000662 ED B0            [21]  157     ldir
      000664 18 03            [12]  158     jr _move_pend
                                    159 
      000666                        160 _last_element:
      000666 DD 35 05         [23]  161     dec a_selected(ix)
                                    162     
      000669                        163 _move_pend:
      000669 DD 6E 03         [19]  164     ld l, a_pend(ix)            ;; calculate the amount of data to move
      00066C DD 66 04         [19]  165     ld h, a_pend+1(ix)          ;; 
      00066F 06 00            [ 7]  166     ld b, #0                    ;; copy the size of an entity in bc
      000671 DD 4E 02         [19]  167     ld c, a_component_size(ix)  ;; 
      000674 ED 42            [15]  168     sbc  hl, bc                 ;;
      000676 DD 75 03         [19]  169     ld a_pend(ix), l            ;; store hl in pend
      000679 DD 74 04         [19]  170     ld a_pend+1(ix), h          ;; 
...
Hexadecimal [24-Bits]
                                    ...
                                    171 
      00067C DD 35 00         [23]  172     dec a_count(ix) 
                                    173 
      00067F C9               [10]  174 ret
                                    175 
                                    176 ;;-----------------------------------------------------------------
                                    177 ;;
                                    178 ;; man_array_get_element
                                    179 ;;
                                    180 ;;  Retrieves in hl the element in position a
                                    181 ;;  Input:  a: number of element to return
                                    182 ;;          ix: array structure
                                    183 ;;  Output: hl: pointer to the element
                                    184 ;;  Modified: AF, BC, DE, HL
                                    185 ;;
      000680                        186 man_array_get_element::
      000680 DD E5            [15]  187     push ix                     ;; load in hl the beginning of the array
      000682 E1               [10]  188     pop hl                      ;;
      000683 11 06 00         [10]  189     ld de, #a_array
      000686 19               [11]  190     add hl, de
                                    191 
      000687 B7               [ 4]  192     or a                        ;; check if we have to retrieve the first card
      000688 C8               [11]  193     ret z                       ;; retrurn if we want to get the first card
                                    194 
      000689 47               [ 4]  195     ld b, a
      00068A 16 00            [ 7]  196     ld d, #0                    ;; copy the size of an entity in de
      00068C DD 5E 02         [19]  197     ld e, a_component_size(ix)  ;; 
      00068F                        198 _g_e_sum_loop:                  ;;
      00068F 19               [11]  199     add hl, de                  ;;  add de to hl until we reach the card
      000690 10 FD            [13]  200     djnz _g_e_sum_loop          ;;
                                    201 
      000692 C9               [10]  202     ret
                                    203 
                                    204 
                                    205 ;;-----------------------------------------------------------------
                                    206 ;;
                                    207 ;; man_array_get_random_element
                                    208 ;;
                                    209 ;;  Retrieves in hl the element in a random position and in a the position
                                    210 ;;  Input:  ix: array structure
                                    211 ;;          a: offset
                                    212 ;;  Output: hl: element
                                    213 ;;          a : number of element.
                                    214 ;;  Modified: AF, BC, DE, HL
                                    215 ;;
      000693                        216 man_array_get_random_element::
      000693 32 A5 06         [13]  217     ld (SUB_OFFSET), a
      000696 32 AA 06         [13]  218     ld (ADD_OFFSET), a
      000699 DD E5            [15]  219     push ix                         ;; load in hl the beginning of the array
      00069B E1               [10]  220     pop hl                          ;;
      00069C 11 06 00         [10]  221     ld de, #a_array 
      00069F 19               [11]  222     add hl, de                      ;; move hl to the beginning of the array
      0006A0 E5               [11]  223     push hl                         ;; save hl (array address)
                                    224 
      0006A1 DD 7E 00         [19]  225     ld a, a_count(ix)               ;; load max number in a
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 109.
Hexadecimal [24-Bits]



                           0000BB   226     SUB_OFFSET = . +1
      0006A4 D6 00            [ 7]  227     sub #0x00
      0006A6 CD 63 17         [17]  228     call sys_util_get_random_number
                           0000C0   229     ADD_OFFSET = . +1
      0006A9 C6 00            [ 7]  230     add #0x00
      0006AB 32 BD 06         [13]  231     ld (_r_e_output), a             ;; store the random number in the output variable
      0006AE E1               [10]  232     pop hl                          ;; restore hl (array address)
      0006AF B7               [ 4]  233     or a                            ;; check if we have to retrieve the first card
      0006B0 CA BC 06         [10]  234     jp z, _g_r_e_return             ;; jump if we wnat to get the first card
                                    235 
      0006B3 47               [ 4]  236     ld b, a
                                    237     ;;ld de, #sizeof_e                ;; copy the size of a card in de
      0006B4 DD 5E 02         [19]  238     ld e, a_component_size(ix)
      0006B7 16 00            [ 7]  239     ld d, #0
      0006B9                        240 _g_r_e_sum_loop:                    ;;
      0006B9 19               [11]  241     add hl, de                      ;;  add de to hl until we reach the card
      0006BA 10 FD            [13]  242     djnz _g_r_e_sum_loop            ;;
                                    243 
      0006BC                        244 _g_r_e_return:
                           0000D3   245 _r_e_output = .+1   
      0006BC 3E 00            [ 7]  246     ld a, #00
      0006BE C9               [10]  247     ret
                                    248 
                                    249 
                                    250 
                                    251 
                                    252 ;;-----------------------------------------------------------------
                                    253 ;;
                                    254 ;; man_array_move_all_elements
                                    255 ;;
                                    256 ;;  moves all the elements form one array to the other
                                    257 ;;  Input:  hl: array from
                                    258 ;;          de: array to
                                    259 ;;  Output: 
                                    260 ;;  Modified: AF, BC, DE, HL
                                    261 ;;
      0006BF                        262 man_array_move_all_elements::
      0006BF 22 CB 06         [16]  263     ld (FIRST_ARRAY), hl
      0006C2 22 DA 06         [16]  264     ld (THIRD_ARRAY), hl
      0006C5 EB               [ 4]  265     ex de, hl
      0006C6 22 D3 06         [16]  266     ld (SECOND_ARRAY), hl
      0006C9                        267 _move_loop:
                           0000E1   268 FIRST_ARRAY = .+2
      0006C9 DD 21 00 00      [14]  269     ld ix, #0000
      0006CD AF               [ 4]  270     xor a
      0006CE CD 80 06         [17]  271     call man_array_get_element
                                    272 
                           0000E9   273 SECOND_ARRAY = .+2
      0006D1 DD 21 00 00      [14]  274     ld ix, #0000
      0006D5 CD 04 06         [17]  275     call man_array_create_element
                                    276 
                           0000F0   277 THIRD_ARRAY = .+2    
      0006D8 DD 21 00 00      [14]  278     ld ix, #0000
      0006DC AF               [ 4]  279     xor a
      0006DD CD 2F 06         [17]  280     call man_array_remove_element
...
Hexadecimal [24-Bits]
                                    ...
                                    281     
      0006E0 DD 7E 00         [19]  282     ld a, a_count(ix)
      0006E3 B7               [ 4]  283     or a
      0006E4 20 E3            [12]  284     jr nz, _move_loop
      0006E6 C9               [10]  285     ret
                                    286 
                                    287 ;;-----------------------------------------------------------------
                                    288 ;;
                                    289 ;; man_array_execute_each
                                    290 ;;
                                    291 ;;  executes the routine pointed in HL for each element in the array pointed in IX
                                    292 ;;  Input:  hl: routine to execute on each
                                    293 ;;          ix: array to loop
                                    294 ;;  Output: 
                                    295 ;;  Modified: AF, BC, DE, HL
                                    296 ;;
      0006E7                        297 man_array_execute_each::
      0006E7 DD 7E 00         [19]  298     ld a, a_count(ix)       ;; retrieve number of elements in the array
      0006EA B7               [ 4]  299     or a                    ;; If no elements in arrary return
      0006EB C8               [11]  300     ret z 
                                    301 
      0006EC 47               [ 4]  302     ld b, a                 ;; move the number of elements to b for indexing djnz
                                    303 
      0006ED 22 15 07         [16]  304     ld (routine), hl        ;; store routine in memory
                                    305 
      0006F0 DD 7E 02         [19]  306     ld a, a_component_size(ix)  ;; store component_size in memory
      0006F3 32 17 07         [13]  307     ld (comp_size), a       ;;    
                                    308     
      0006F6 DD E5            [15]  309     push ix                 ;; load start of array in hl
      0006F8 E1               [10]  310     pop hl                  ;;
      0006F9 11 06 00         [10]  311     ld de, #a_array         ;;
      0006FC 19               [11]  312     add hl, de              ;;
                                    313     
      0006FD E5               [11]  314     push hl                 ;;
      0006FE DD E1            [14]  315     pop ix                  ;;  load ix with the first element
                                    316 
      000700                        317 loop_each:
      000700 C5               [11]  318     push bc                 ;; save index in stack
      000701 21 09 07         [10]  319     ld hl, #return_point    ;;
      000704 E5               [11]  320     push hl                 ;; set the return point in the stack
                                    321 
      000705 2A 15 07         [16]  322     ld hl, (routine)        ;; Move routine to hl
      000708 E9               [ 4]  323     jp (hl)                 ;; jump to the routine
                                    324 
      000709                        325 return_point:
      000709 16 00            [ 7]  326     ld d, #0                ;; retrieve component_size
      00070B 3A 17 07         [13]  327     ld a, (comp_size)       ;;
      00070E 5F               [ 4]  328     ld e, a                 ;;
                                    329 
      00070F DD 19            [15]  330     add ix, de              ;; move ix to the next element
                                    331 
      000711 C1               [10]  332     pop bc                  ;; restore index
      000712 10 EC            [13]  333     djnz loop_each
                                    334 
      000714 C9               [10]  335     ret
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180 / ZX-Next / eZ80), page 111.
Hexadecimal [24-Bits]



      000715 00 00                  336 routine: .dw #0000
      000717 00                     337 comp_size: .db #0
