...
Hexadecimal [16-Bits]
                             ...
                             30 ;;
                             31 .area _DATA
   1E6D 00 00                32 routine:        .dw #0000
   1E6F 00                   33 comp_size:      .db #0
   1E70 00                   34 comp_type:      .db #0
   1E71 00 00                35 routine_iY:     .dw #0000
   1E73 00                   36 comp_size_iY:   .db #0
   1E74 00                   37 comp_type_iY:   .db #0
                             38 
                             39 
                             40 ;;
                             ...
                             47 ;; man_array_init
                             48 ;;
                             49 ;;  Initilizes an array
                             50 ;;  Input: ix points to the array
                             51 ;;  Output: 
                             52 ;;  Modified: AF, HL
                             53 ;;
   086C                      54 man_array_init::
   086C AF            [ 4]   55     xor a
   086D DD 77 00      [19]   56     ld a_count(ix), a           ;; Initialize the number of elements in the array
                             57 
   0004                      58     ld__hl_ix                   ;; point hl to the start of the array 
                              1    ;; LD HL, IX
                              2    ;;------------
   0004                       3    ld__a_ixl
   0870 DD 7D                 1    .dw #0x7DDD  ;; Opcode for ld a, ixl
   0872 6F            [ 4]    4    ld  l, a
   0007                       5    ld__a_ixh
   0873 DD 7C                 1    .dw #0x7CDD  ;; Opcode for ld a, ixh
   0875 67            [ 4]    6    ld  h, a
                              7    ;;------------
   0876 3E 07         [ 7]   59     ld a, #a_array
   000C                      60     add_hl_a
   000C                       1    add_REGPAIR_a  h, l
                              1    ;; First Perform RH = E + A
   0878 85            [ 4]    2    add l    ;; [1] A' = RL + A 
   0879 6F            [ 4]    3    ld  l, a ;; [1] RL' = A' = RL + A. It might generate Carry that must be added to RH
                              4    
                              5    ;; Then Perform RH = RH + Carry 
   087A 8C            [ 4]    6    adc h    ;; [1] A'' = A' + RH + Carry = RL + A + RH + Carry
   087B 95            [ 4]    7    sub l    ;; [1] Remove RL'. A''' = A'' - RL' = RL + A + RH + Carry - (RL + A) = RH + Carry
   087C 67            [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
...
Hexadecimal [16-Bits]
                             ...
                             61     
   087D DD 75 04      [19]   62     ld a_pend(ix), l            ;; load pointer to the end in hl
   0880 DD 74 05      [19]   63     ld a_pend+1(ix), h
                             64 
   0883 36 00         [10]   65     ld  (hl), #e_type_invalid   ;;ponemos el primer elemento del array con tipo invalido
   0885 C9            [10]   66     ret
                             67 
                             68 
                             69 ;;-----------------------------------------------------------------
                             70 ;;
                             71 ;; man_array_create_element
                             72 ;;
                             73 ;;  Create an element from the model pointed by HL
                             74 ;;  Input:  ix: pointer to the array 
                             75 ;;          hl: pointer to the entity to add to the array
                             76 ;;  Output: hl: points to the new created entity
                             77 ;;  Modified: AF, BC, DE, HL
                             78 ;;
   0886                      79 man_array_create_element::
                             80     ;; Is there free space?
   0886 DD 7E 00      [19]   81     ld a, a_count(ix)
   0889 47            [ 4]   82     ld b, a
   088A DD 7E 03      [19]   83     ld a, a_component_max_number(ix)
   088D B8            [ 4]   84     cp b
   088E C8            [11]   85     ret z
                             86     
   088F 06 00         [ 7]   87     ld b, #0                        ;; bc = component size
   0891 DD 7E 02      [19]   88     ld a, a_component_size(ix)      ;;
   0894 4F            [ 4]   89     ld c, a                         ;;    
   0895 32 AF 08      [13]   90     ld (_create_size), a            ;; sm code to move the size of the entity to bc
   0898 AF            [ 4]   91     xor a                           ;; ld a, #0
   0899 32 B0 08      [13]   92     ld (_create_size+1), a          ;;
                             93     
   089C DD 5E 04      [19]   94     ld e, a_pend(ix)                ;; Load the address of the next element in de
   089F DD 56 05      [19]   95     ld d, a_pend+1(ix)              ;;
   08A2 D5            [11]   96     push de                         ;; Store the address of the next element to return it at the end
   08A3 ED B0         [21]   97     ldir                            ;; de=pend, bc=component_size, hl=pointer to the entity to be added
                             98 
   08A5 DD 34 00      [23]   99     inc a_count(ix)                 ;; increase the number of entities
                            100 
   08A8 DD 6E 04      [19]  101     ld l, a_pend(ix)                ;; load in hl the pointer to the next entity
   08AB DD 66 05      [19]  102     ld h, a_pend+1(ix)
                     0043   103 _create_size = .+1
   08AE 01 00 00      [10]  104     ld   bc, #00
   08B1 09            [11]  105     add  hl, bc
                            106 
   08B2 DD 75 04      [19]  107     ld   a_pend(ix), l              ;; update the pointer to the next entity
   08B5 DD 74 05      [19]  108     ld   a_pend+1(ix), h            ;;
                            109 
   08B8 E1            [10]  110     pop hl                          ;; restore the new element address in hl
                            111 
   08B9 C9            [10]  112     ret
                            113 
                            114 
...
Hexadecimal [16-Bits]
                            ...
                            117 ;;-----------------------------------------------------------------
                            118 ;;
                            119 ;; man_array_remove_element
                            120 ;;
                            121 ;;  Remove a element pointed by a from the array
                            122 ;;  Input: a: number of element to remove
                            123 ;;  Output: 
                            124 ;;  Modified: AF, BC, DE, HL
                            125 ;;
   08BA                     126 man_array_remove_element::
                            127 
   08BA 47            [ 4]  128     ld b, a                     ;; copy element to erase to b
   08BB DD 7E 00      [19]  129     ld a, a_count(ix)           ;; check if we have to erase the last element
   08BE 3D            [ 4]  130     dec a                       ;;
   08BF B8            [ 4]  131     cp b                        ;;
   08C0 28 2B         [12]  132     jr z, _last_element         ;;  jump if we have to erase the last element
                            133 
   08C2 CD C0 09      [17]  134     call man_array_first_element ;; load start of array in hl
                            135 
                            136 
   08C5 78            [ 4]  137     ld a, b                     ;; restore a value from b
   08C6 B7            [ 4]  138     or a                        ;; if we have to erase the first element we are don with hl
   08C7 CA D2 08      [10]  139     jp z, _calc_end_of_element  ;; 
                            140 
   08CA 16 00         [ 7]  141     ld d, #0                 ;; copy the size of an entity in de
   08CC DD 5E 02      [19]  142     ld e, a_component_size(ix)  ;;
   08CF                     143 _start_loop:                    ;;
   08CF 19            [11]  144     add hl, de                  ;; hl advance a card
   08D0 10 FD         [13]  145     djnz _start_loop            ;; hl points to the start of the element to remove
                            146 
   08D2                     147 _calc_end_of_element:
   08D2 54            [ 4]  148     ld d, h                     ;; copy hl in de-> de=start of the element to remove
   08D3 5D            [ 4]  149     ld e, l                     ;;
                            150 
   08D4 06 00         [ 7]  151     ld b, #0                    ;; add size of an element to hl
   08D6 DD 4E 02      [19]  152     ld c, a_component_size(ix)  ;; 
   08D9 09            [11]  153     add hl,bc                   ;; hl= end of the element to remove
                            154 
   08DA D5            [11]  155     push de                     ;; save de
   08DB E5            [11]  156     push hl                     ;; save hl
   08DC EB            [ 4]  157     ex de, hl                   ;; we have in de the end of the element to remove
                            158 
   08DD DD 6E 04      [19]  159     ld l, a_pend(ix)            ;; calculate the amount of data to move
   08E0 DD 66 05      [19]  160     ld h, a_pend+1(ix)          ;; 
   08E3 ED 52         [15]  161     sbc hl, de                  ;;
   08E5 44            [ 4]  162     ld b, h                     ;; move hl to bc
   08E6 4D            [ 4]  163     ld c, l                     ;; bc = size of data to move
                            164 
   08E7 E1            [10]  165     pop hl                      ;; restore hl
   08E8 D1            [10]  166     pop de                      ;; restore de
                            167 
   08E9 ED B0         [21]  168     ldir
   08EB 18 03         [12]  169     jr _move_pend
                            170 
...
Hexadecimal [16-Bits]
   ...
   08ED                     171 _last_element:
   08ED DD 35 06      [23]  172     dec a_selected(ix)
                            173     
   08F0                     174 _move_pend:
   08F0 DD 6E 04      [19]  175     ld l, a_pend(ix)            ;; calculate the amount of data to move
   08F3 DD 66 05      [19]  176     ld h, a_pend+1(ix)          ;; 
   08F6 06 00         [ 7]  177     ld b, #0                    ;; copy the size of an entity in bc
   08F8 DD 4E 02      [19]  178     ld c, a_component_size(ix)  ;; 
   08FB ED 42         [15]  179     sbc  hl, bc                 ;;
   08FD DD 75 04      [19]  180     ld a_pend(ix), l            ;; store hl in pend
   0900 DD 74 05      [19]  181     ld a_pend+1(ix), h          ;; 
                            182 
   0903 DD 35 00      [23]  183     dec a_count(ix) 
                            184 
   0906 C9            [10]  185 ret
                            186 
                            187 ;;-----------------------------------------------------------------
                            188 ;;
                            189 ;; man_array_get_element
                            190 ;;
                            191 ;;  Retrieves in hl the element in position a
                            192 ;;  Input:  a: number of element to return
                            193 ;;          ix: array structure
                            194 ;;  Output: hl: pointer to the element
                            195 ;;  Modified: AF, BC, DE, HL
                            196 ;;
   0907                     197 man_array_get_element::
                            198 
   0907 CD C0 09      [17]  199     call man_array_first_element ;; load start of array in hl
                            200 
   090A B7            [ 4]  201     or a                        ;; check if we have to retrieve the first card
   090B C8            [11]  202     ret z                       ;; retrurn if we want to get the first card
                            203 
   090C 47            [ 4]  204     ld b, a
   090D 16 00         [ 7]  205     ld d, #0                    ;; copy the size of an entity in de
   090F DD 5E 02      [19]  206     ld e, a_component_size(ix)  ;; 
   0912                     207 _g_e_sum_loop:                  ;;
   0912 19            [11]  208     add hl, de                  ;;  add de to hl until we reach the card
   0913 10 FD         [13]  209     djnz _g_e_sum_loop          ;;
                            210 
   0915 C9            [10]  211     ret
                            212 
                            213 
                            214 ;;-----------------------------------------------------------------
                            215 ;;
                            216 ;; man_array_get_random_element
                            217 ;;
                            218 ;;  Retrieves in hl the element in a random position and in a the position
                            219 ;;  Input:  ix: array structure
                            220 ;;          a: offset
                            221 ;;  Output: hl: element
                            222 ;;          a : number of element.
                            223 ;;  Modified: AF, BC, DE, HL
                            224 ;;
   0916                     225 man_array_get_random_element::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 106.
Hexadecimal [16-Bits]



   0916 32 20 09      [13]  226     ld (SUB_OFFSET), a
   0919 32 25 09      [13]  227     ld (ADD_OFFSET), a
                            228 
   091C DD 7E 00      [19]  229     ld a, a_count(ix)               ;; load max number in a
                     00B4   230     SUB_OFFSET = . +1
   091F D6 00         [ 7]  231     sub #0x00
   0921 CD 2C 0B      [17]  232     call sys_util_get_random_number
                     00B9   233     ADD_OFFSET = . +1
   0924 C6 00         [ 7]  234     add #0x00
   0926 32 2D 09      [13]  235     ld (_r_e_output), a             ;; save the random number in the output variable
                            236     
   0929 CD 07 09      [17]  237     call man_array_get_element
                            238 
                     00C1   239 _r_e_output = .+1   
   092C 3E 00         [ 7]  240     ld a, #00
   092E C9            [10]  241     ret
                            242 
                            243 
                            244 
                            ...
                            246 ;;-----------------------------------------------------------------
                            247 ;;
                            248 ;; man_array_move_all_elements
                            249 ;;
                            250 ;;  moves all the elements form one array to the other
                            251 ;;  Input:  hl: array from
                            252 ;;          de: array to
                            253 ;;  Output: 
                            254 ;;  Modified: AF, BC, DE, HL
                            255 ;;
   092F                     256 man_array_move_all_elements::
   092F 22 3B 09      [16]  257     ld (FIRST_ARRAY), hl
   0932 22 4A 09      [16]  258     ld (THIRD_ARRAY), hl
   0935 EB            [ 4]  259     ex de, hl
   0936 22 43 09      [16]  260     ld (SECOND_ARRAY), hl
   0939                     261 _move_loop:
                     00CF   262 FIRST_ARRAY = .+2
   0939 DD 21 00 00   [14]  263     ld ix, #0000
   093D AF            [ 4]  264     xor a
   093E CD 07 09      [17]  265     call man_array_get_element
                            266 
                     00D7   267 SECOND_ARRAY = .+2
   0941 DD 21 00 00   [14]  268     ld ix, #0000
   0945 CD 86 08      [17]  269     call man_array_create_element
                            270 
                     00DE   271 THIRD_ARRAY = .+2    
   0948 DD 21 00 00   [14]  272     ld ix, #0000
   094C AF            [ 4]  273     xor a
   094D CD BA 08      [17]  274     call man_array_remove_element
                            275     
   0950 DD 7E 00      [19]  276     ld a, a_count(ix)
   0953 B7            [ 4]  277     or a
   0954 20 E3         [12]  278     jr nz, _move_loop
   0956 C9            [10]  279     ret
                            280 
...
Hexadecimal [16-Bits]
                            ...
                            281 ;;-----------------------------------------------------------------
                            282 ;;
                            283 ;; man_array_execute_each
                            284 ;;
                            285 ;;  executes the routine pointed in HL for each element in the array pointed in IX
                            286 ;;  Input:  hl: routine to execute on each
                            287 ;;          ix: array to loop
                            288 ;;  Output: 
                            289 ;;  Modified: AF, BC, DE, HL
                            290 ;;
   0957                     291 man_array_execute_each::
   0957 DD E5         [15]  292     push ix                 ;; save ix 
                            293     
   0959 DD 7E 00      [19]  294     ld a, a_count(ix)       ;; retrieve number of elements in the array
   095C B7            [ 4]  295     or a                    ;; If no elements in arrary return
   095D C8            [11]  296     ret z 
                            297 
   095E 47            [ 4]  298     ld b, a                 ;; move the number of elements to b for indexing djnz
                            299 
   095F 22 6D 1E      [16]  300     ld (routine), hl        ;; store routine in memory
                            301 
   0962 DD 7E 02      [19]  302     ld a, a_component_size(ix)  ;; store component_size in memory
   0965 32 6F 1E      [13]  303     ld (comp_size), a       ;;    
                            304     
   0968 CD C0 09      [17]  305     call man_array_first_element ;; load start of array in hl
                            306     
   096B E5            [11]  307     push hl                 ;;
   096C DD E1         [14]  308     pop ix                  ;;  load ix with the first element
                            309 
   096E                     310 loop_each:
   096E C5            [11]  311     push bc                 ;; save index in stack
   096F 21 77 09      [10]  312     ld hl, #return_point    ;;
   0972 E5            [11]  313     push hl                 ;; set the return point in the stack
                            314 
   0973 2A 6D 1E      [16]  315     ld hl, (routine)        ;; Move routine to hl
   0976 E9            [ 4]  316     jp (hl)                 ;; jump to the routine
                            317 
   0977                     318 return_point:
   0977 16 00         [ 7]  319     ld d, #0                ;; retrieve component_size
   0979 3A 6F 1E      [13]  320     ld a, (comp_size)       ;;
   097C 5F            [ 4]  321     ld e, a                 ;;
                            322 
   097D DD 19         [15]  323     add ix, de              ;; move ix to the next element
                            324 
   097F C1            [10]  325     pop bc                  ;; restore index
   0980 10 EC         [13]  326     djnz loop_each
                            327 
   0982 DD E1         [14]  328     pop ix                  ;; restore ix
                            329 
   0984 C9            [10]  330     ret
                            331 
                            332 ;;-----------------------------------------------------------------
                            333 ;;
                            334 ;; man_array_execute_each_matching
                            335 ;;
...
Hexadecimal [16-Bits]
                            ...
                            336 ;;  executes the routine pointed in HL for each element in the array pointed in IX that
                            337 ;;  matches the component type
                            338 ;;  Input:  hl: routine to execute on each
                            339 ;;          a : component to match
                            340 ;;          ix: array to loop
                            341 ;;  Output: 
                            342 ;;  Modified: AF, BC, DE, HL
                            343 ;;
   0985                     344 man_array_execute_each_matching::
   0985 DD E5         [15]  345     push ix                 ;; save ix 
   0987 32 70 1E      [13]  346     ld (comp_type), a       ;; save component to match for later
                            347 
   098A DD 7E 00      [19]  348     ld a, a_count(ix)       ;; retrieve number of elements in the array
   098D B7            [ 4]  349     or a                    ;; If no elements in arrary return
   098E C8            [11]  350     ret z                   ;;
                            351 
   098F 47            [ 4]  352     ld b, a                 ;; move the number of elements to b for indexing djnz
                            353 
   0990 22 6D 1E      [16]  354     ld (routine), hl        ;; store routine in memory
                            355 
   0993 DD 7E 02      [19]  356     ld a, a_component_size(ix)  ;; store component_size in memory
   0996 32 6F 1E      [13]  357     ld (comp_size), a       ;;    
                            358     
   0999 CD C0 09      [17]  359     call man_array_first_element ;; load start of array in hl
                            360     
   099C E5            [11]  361     push hl                 ;;
   099D DD E1         [14]  362     pop ix                  ;;  load ix with the first element
                            363 
   099F                     364 matching_loop_each:
   099F C5            [11]  365     push bc                 ;; save index in stack
                            366 
   09A0 3A 70 1E      [13]  367     ld a, (comp_type)       ;; Retrieve the component type to match
   09A3 47            [ 4]  368     ld b, a                 ;;
   09A4 DD 7E 00      [19]  369     ld a, e_cmps(ix)             ;; retrieve the type of the current component
   09A7 B8            [ 4]  370     cp b                    ;; Compare if they match
   09A8 20 08         [12]  371     jr nz, matching_return_point      ;; Jump to continue in case they don't match
                            372 
   09AA 21 B2 09      [10]  373     ld hl, #matching_return_point    ;;
   09AD E5            [11]  374     push hl                 ;; set the return point in the stack
                            375 
   09AE 2A 6D 1E      [16]  376     ld hl, (routine)        ;; Move routine to hl
   09B1 E9            [ 4]  377     jp (hl)                 ;; jump to the routine
                            378 
   09B2                     379 matching_return_point:
   09B2 16 00         [ 7]  380     ld d, #0                ;; retrieve component_size
   09B4 3A 6F 1E      [13]  381     ld a, (comp_size)       ;;
   09B7 5F            [ 4]  382     ld e, a                 ;;
                            383 
   09B8 DD 19         [15]  384     add ix, de              ;; move ix to the next element
                            385 
   09BA C1            [10]  386     pop bc                  ;; restore index
   09BB 10 E2         [13]  387     djnz matching_loop_each
                            388 
   09BD DD E1         [14]  389     pop ix                  ;; restore ix
                            390 
...
Hexadecimal [16-Bits]
   ...
   09BF C9            [10]  391     ret    
                            ...
                            397 ;;-----------------------------------------------------------------
                            398 ;;
                            399 ;; man_array_first_element
                            400 ;;
                            401 ;;  returns in hl the address to the first element of the array
                            402 ;;  Input:  
                            403 ;;  Output: ix : first element of the array
                            404 ;;  Modified: AF, BC, DE, HL
                            405 ;;
   09C0                     406 man_array_first_element:: ;; Changes the entity controller to ix register
   0154                     407     cpctm_push de
                     0001     1    .narg v
                     0001     2    .if v
   09C0 D5            [11]    3    push de
                     0000     4    .if v-1
                              5    push 
                              6    .if v-2
                              7    push 
                     ...
                     0001    26    .else
                             27    .mexit
   09C1 DD E5         [15]  408     push ix                     ;; hl to the start of the array    
   09C3 E1            [10]  409     pop hl                      ;;
   09C4 11 07 00      [10]  410     ld de, #a_array             ;;
   09C7 19            [11]  411     add hl, de                  ;;
   015C                     412     cpctm_pop de
                     0001     1    .narg v
                     0001     2    .if v
   09C8 D1            [10]    3    pop de
                     0000     4    .if v-1
