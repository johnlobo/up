...
Hexadecimal [16-Bits]
                             ...
                             33 
   0000                      34 entities::
   0000                      35 DefineArray e, MAX_ENTITIES, sizeof_e     
   1E44 00                    1       e_count::                     .db 0
   1E45 00                    2       e_delta::                     .db 0
   1E46 0D                    3       e_component_size::            .db sizeof_e
   1E47 0A                    4       e_component_max_number::      .db MAX_ENTITIES
   1E48 4B 1E                 5       e_pend::                      .dw e_array 
   1E4A 00                    6       e_selected::                  .db 0
   1E4B                       7       e_array::
   1E4B                       8             .ds MAX_ENTITIES * sizeof_e
   1ECD 00                   36 .db 0   ;;ponemos este aqui como trampita para que siempre haya un tipo invalido al final
                             37 
   1ECE                      38 entityTpl::
   008A                      39 DefineEntity e_cmps_default, 100, 100, 8, 40, 0, 0, _s_player_0, #0000, #0000
   1ECE 23                    1     .db e_cmps_default
   1ECF 64                    2     .db 100
   1ED0 64                    3     .db 100
   1ED1 08                    4     .db 8
   1ED2 28                    5     .db 40
   1ED3 00                    6     .db 0
   1ED4 00                    7     .db 0
   1ED5 00 02                 8     .dw _s_player_0
   1ED7 00 00                 9     .dw #0000
   1ED9 00 00                10     .dw #0000
                             40 
                             41 ;;
                             42 ;; Start of _CODE area
                             43 ;; 
                             44 .area _CODE
                             45 
                             46 ;;-----------------------------------------------------------------
                             ...
                             51 ;;  Input: 
                             52 ;;  Output: 
                             53 ;;  Modified: AF, BC, DE, HL
                             54 ;;
   09CA                      55 man_game_init::
                             56 
   09CA DD 21 44 1E   [14]   57     ld ix, #entities
   09CE CD 6C 08      [17]   58     call man_array_init
   09D1 CD 86 08      [17]   59     call man_array_create_element
...
Hexadecimal [16-Bits]
                             ...
                             60 
   09D4 21 CE 1E      [10]   61     ld hl, #entityTpl
   09D7 06 00         [ 7]   62     ld b, #0
   09D9 DD 4E 02      [19]   63     ld c, a_component_size(ix)
   09DC ED B0         [21]   64     ldir
                             65 
   09DE C9            [10]   66     ret
                             67 
                             68 ;;-----------------------------------------------------------------
                             ...
                             73 ;;  Input: 
                             74 ;;  Output: 
                             75 ;;  Modified: AF, BC, DE, HL
                             76 ;;
   09DF                      77 man_game_update::
   09DF C9            [10]   78     ret
