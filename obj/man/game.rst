...
Hexadecimal [16-Bits]
                             ...
                             34 
   0000                      35 entities::
   0000                      36 DefineArray e, MAX_ENTITIES, sizeof_e     
   1E75 00                    1       e_count::                     .db 0
   1E76 00                    2       e_delta::                     .db 0
   1E77 0D                    3       e_component_size::            .db sizeof_e
   1E78 0A                    4       e_component_max_number::      .db MAX_ENTITIES
   1E79 7C 1E                 5       e_pend::                      .dw e_array 
   1E7B 00                    6       e_selected::                  .db 0
   1E7C                       7       e_array::
   1E7C                       8             .ds MAX_ENTITIES * sizeof_e
   1EFE 00                   37 .db 0   ;;ponemos este aqui como trampita para que siempre haya un tipo invalido al final
                             38 
   1EFF                      39 entityTpl::
   008A                      40 DefineEntity e_cmps_default, 100, 100, 8, 40, 0, 0, _s_player_0, #0000, #0000
   1EFF 47                    1     .db e_cmps_default
   1F00 64                    2     .db 100
   1F01 64                    3     .db 100
   1F02 08                    4     .db 8
   1F03 28                    5     .db 40
   1F04 00                    6     .db 0
   1F05 00                    7     .db 0
   1F06 00 02                 8     .dw _s_player_0
   1F08 00 00                 9     .dw #0000
   1F0A 00 00                10     .dw #0000
                             41 
                             42 ;;
                             ...
                             55 ;;
   09CA                      56 man_game_init::
                             57 
   09CA DD 21 75 1E   [14]   58     ld ix, #entities
   09CE CD 6C 08      [17]   59     call man_array_init
   09D1 CD 86 08      [17]   60     call man_array_create_element
...
Hexadecimal [16-Bits]
                             ...
                             61 
   09D4 21 FF 1E      [10]   62     ld hl, #entityTpl
   09D7 06 00         [ 7]   63     ld b, #0
   09D9 DD 4E 02      [19]   64     ld c, a_component_size(ix)
   09DC ED B0         [21]   65     ldir
                             66 
   09DE C9            [10]   67     ret
                             68 
                             69 ;;-----------------------------------------------------------------
                             ...
                             74 ;;  Input: 
                             75 ;;  Output: 
                             76 ;;  Modified: AF, BC, DE, HL
                             77 ;;
   09DF                      78 man_game_update::
   09DF CD C9 0A      [17]   79     call sys_render_update
   09E2 C9            [10]   80     ret
