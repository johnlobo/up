...
Hexadecimal [16-Bits]
                             ...
                             20 ;;===============================================================================
                             21 
                             22 .globl sys_render_init
                             23 .globl sys_render_update
...
Hexadecimal [16-Bits]
                             ...
                             31 .area _DATA
                             32 
                             33 ;; Define one Zero-terminated string to be used later on
   0C1F 43 50 43 74 65 6C    34 string: .asciz "CPCtelera up and running!";
        65 72 61 20 75 70
        20 61 6E 64 20 72
        75 6E 6E 69 6E 67
        21 00
                             ...
                             49 .globl cpct_setDrawCharM1_asm
                             50 .globl cpct_drawStringM1_asm
                             51 
                             52 ;;
                             ...
                             55 ;;
   05C2                      56 _main::
                             57    ;; Disable firmware to prevent it from interfering with string drawing
   05C2 CD 53 0A      [17]   58    call cpct_disableFirmware_asm
                             59 
                             60    ;; Set up draw char colours before calling draw string
   05C5 16 00         [ 7]   61    ld    d, #0         ;; D = Background PEN (0)
   05C7 1E 03         [ 7]   62    ld    e, #3         ;; E = Foreground PEN (3)
                             63 
   05C9 CD A3 0B      [17]   64    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             65 
                             66    ;; Calculate a video-memory location for printing a string
   05CC 11 00 C0      [10]   67    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   05CF 06 18         [ 7]   68    ld    b, #24                  ;; B = y coordinate (24 = 0x18)
   05D1 0E 10         [ 7]   69    ld    c, #16                  ;; C = x coordinate (16 = 0x10)
                             70 
   05D3 CD 53 0B      [17]   71    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             72 
                             73    ;; Print the string in video memory
                             74    ;; HL already points to video memory, as it is the return
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 103.
Hexadecimal [16-Bits]



                             75    ;; value from cpct_getScreenPtr_asm
   05D6 FD 21 1F 0C   [14]   76    ld   iy, #string    ;; IY = Pointer to the string 
                             77 
   05DA CD 21 08      [17]   78    call cpct_drawStringM1_asm  ;; Draw the string
                             79 
                             80    ;; Loop forever
   05DD                      81 loop:
   05DD 18 FE         [12]   82    jr    loop
