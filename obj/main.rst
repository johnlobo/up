...
Hexadecimal [16-Bits]
                             ...
                             37 .area _DATA
                             38 
   1DF8 20 47 41 4D 45 20    39 _game_loaded_string: .asciz " GAME LOADED - V.001"      ;;27 chars, 54 bytes
        4C 4F 41 44 45 44
        20 2D 20 56 2E 30
        30 31 00
                             40 
   ...
   0842                      56 main_init::
                             ...
                             59 ;;
   0842 CD 8E 0A      [17]   60    call sys_render_init
                             61 
   0845 1E 06         [ 7]   62    ld e, #6                           ;; x
   0847 16 4E         [ 7]   63    ld d, #78                           ;; y
   0849 06 2C         [ 7]   64    ld b, #44                           ;; h
   084B 0E 3C         [ 7]   65    ld c, #60                           ;; w
   084D 21 F8 1D      [10]   66    ld hl, #_game_loaded_string         ;; message
   0850 3E 01         [ 7]   67    ld a, #1                            ;; wait for a key
   0852 CD B7 0B      [17]   68    call sys_messages_show
                             69 
                             70    ;; set random seed using hl form message show
                             71 
   0855 CD 66 1B      [17]   72    call cpct_setSeed_mxor_asm
                             73      
   0858 C9            [10]   74    ret
                             75    
                             76 ;;-----------------------------------------------------------------
...
Hexadecimal [16-Bits]
   ...
   0859 31 00 80      [10]   83    ld sp, #0x8000                               ;; Move the stack to 0x8000
                             84    
   085C CD 47 0A      [17]   85    call sys_system_disable_firmware
                             86 
