...
Hexadecimal [16-Bits]
                             ...
                             37 .area _DATA
                             38 
   1B2F 20 47 41 4D 45 20    39 _game_loaded_string: .asciz " GAME LOADED - V.001"      ;;27 chars, 54 bytes
        4C 4F 41 44 45 44
        20 2D 20 56 2E 30
        30 31 00
                             40 
   ...
   05C2                      56 main_init::
                             ...
                             59 ;;
   05C2 CD C8 07      [17]   60    call sys_render_init
                             61 
   05C5 1E 06         [ 7]   62    ld e, #6                           ;; x
   05C7 16 4E         [ 7]   63    ld d, #78                           ;; y
   05C9 06 2C         [ 7]   64    ld b, #44                           ;; h
   05CB 0E 3C         [ 7]   65    ld c, #60                           ;; w
   05CD 21 2F 1B      [10]   66    ld hl, #_game_loaded_string         ;; message
   05D0 3E 01         [ 7]   67    ld a, #1                            ;; wait for a key
   05D2 CD 6B 0A      [17]   68    call sys_messages_show
                             69 
                             70    ;; set random seed using hl form message show
                             71 
   05D5 CD 9F 18      [17]   72    call cpct_setSeed_mxor_asm
                             73      
   05D8 C9            [10]   74    ret
                             75    
                             76 ;;-----------------------------------------------------------------
...
Hexadecimal [16-Bits]
   ...
   05D9 31 00 80      [10]   83    ld sp, #0x8000                               ;; Move the stack to 0x8000
                             84    
   05DC CD 81 07      [17]   85    call sys_system_disable_firmware
                             86 
   05DF CD C2 05      [17]   87    call main_init
                             88 
   05E2                      89 start:
                             90 
   05E2 CD 18 07      [17]   91    call man_game_init
                             92 
                             93 ;; Loop forever
   05E5                      94 loop:
                             95    
   05E5 CD 19 07      [17]   96    call man_game_update
                             97    
