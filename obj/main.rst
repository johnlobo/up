...
Hexadecimal [24-Bits]
                                     ...
                                     37 .area _DATA
                                     38 
      001B31 20 47 41 4D 45 20 4C    39 _game_loaded_string: .asciz " GAME LOADED - V.001"      ;;27 chars, 54 bytes
...
Hexadecimal [24-Bits]
      ...
      0005D9 31 00 80         [10]   83    ld sp, #0x8000                               ;; Move the stack to 0x8000
                                     84    
      0005DC CD 82 15         [17]   85    call sys_system_disable_firmware
                                     86 
      0005DF CD C2 05         [17]   87    call main_init
                                     88 
      0005E2                         89 start:
                                     90 
      0005E2 CD 1A 07         [17]   91    call man_game_init
                                     92 
                                     93 ;; Loop forever
      0005E5                         94 loop:
                                     95    
      0005E5 CD 1B 07         [17]   96    call man_game_update
                                     97    
